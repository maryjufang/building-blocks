...
var u="suspendedStart",c="suspendedYield",l="executing",f="completed",h={},p=v.prototype=g.prototype
y.prototype=p.constructor=v,v.constructor=y,v[o]=y.displayName="GeneratorFunction",s.isGeneratorFunction=function(e){var t="function"==typeof e&&e.constructor
return!!t&&(t===y||"GeneratorFunction"===(t.displayName||t.name))},s.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,v):(e.__proto__=v,o in e||(e[o]="GeneratorFunction")),e.prototype=Object.create(p),e},s.awrap=function(e){return new _(e)},b(w.prototype),s.async=function(e,t,n,r){var i=new w(d(e,t,n,r))
...
if(r in e)return n.value=r,n.done=!1,n}return n.done=!0,n}},s.values=T,O.prototype={constructor:O,reset:function(e){if(this.prev=0,this.next=0,this.sent=this._sent=t,this.done=!1,this.delegate=null,this.tryEntries.forEach(E),!e)for(var r in this)"t"===r.charAt(0)&&n.call(this,r)&&!isNaN(+r.slice(1))&&(this[r]=t)},stop:function(){this.done=!0
...
E(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:T(e),resultName:t,nextLoc:n},h}}}function d(e,n,r,i){var o=n&&n.prototype instanceof g?n:g,a=Object.create(o.prototype),s=new O(i||[])
...
if(d.arg!==h)return g
r.delegate&&"next"===o&&(a=t)}else"throw"===d.type&&(i=f,o="throw",a=d.arg)}}}(e,r,s),a}function m(e,t,n){try{return{type:"normal",arg:e.call(t,n)}}catch(e){return{type:"throw",arg:e}}}function g(){}function y(){}function v(){}function b(e){["next","throw","return"].forEach(function(t){e[t]=function(e){return this._invoke(t,e)}})}function _(e){this.arg=e}function w(e){function t(n,r,i,o){var a=m(e[n],e,r)
...
t.type="normal",delete t.arg,e.completion=t}function O(e){this.tryEntries=[{tryLoc:"root"}],e.forEach(x,this),this.reset(!0)}function T(e){if(e){var r=e[i]
...
var E=function(e){var t,n,r,i,o,a,s,u,c,l,f,h,p,d,m,g,y,v,b,_="sizzle"+1*new Date,w=e.document,x=0,E=0,O=ae(),T=ae(),C=ae(),k=function(e,t){return e===t&&(f=!0),0},S={}.hasOwnProperty,A=[],M=A.pop,P=A.push,R=A.push,j=A.slice,N=function(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n]===t)return n
return-1},D="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",L="[\\x20\\t\\r\\n\\f]",I="(?:\\\\.|[\\w-]|[^\0-\\xa0])+",F="\\["+L+"*("+I+")(?:"+L+"*([*^$|!~]?=)"+L+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+I+"))|)"+L+"*\\]",q=":("+I+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+F+")*)|.*)\\)|)",z=new RegExp(L+"+","g"),U=new RegExp("^"+L+"+|((?:^|[^\\\\])(?:\\\\.)*)"+L+"+$","g"),B=new RegExp("^"+L+"*,"+L+"*"),H=new RegExp("^"+L+"*([>+~]|"+L+")"+L+"*"),V=new RegExp("="+L+"*([^\\]'\"]*?)"+L+"*\\]","g"),W=new RegExp(q),Y=new RegExp("^"+I+"$"),G={ID:new RegExp("^#("+I+")"),CLASS:new RegExp("^\\.("+I+")"),TAG:new RegExp("^("+I+"|[*])"),ATTR:new RegExp("^"+F),PSEUDO:new RegExp("^"+q),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+L+"*(even|odd|(([+-]|)(\\d*)n|)"+L+"*(?:([+-]|)"+L+"*(\\d+)|))"+L+"*\\)|)","i"),bool:new RegExp("^(?:"+D+")$","i"),needsContext:new RegExp("^"+L+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+L+"*((?:-\\d)?\\d*)"+L+"*\\)|)(?=[^-]|$)","i")},Q=/^(?:input|select|textarea|button)$/i,K=/^h\d$/i,$=/^[^{]+\{\s*\[native \w/,X=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,J=/[+~]/,Z=new RegExp("\\\\([\\da-f]{1,6}"+L+"?|("+L+")|.)","ig"),ee=function(e,t,n){var r="0x"+t-65536
...
try{R.apply(A=j.call(w.childNodes),w.childNodes),A[w.childNodes.length].nodeType}catch(e){R={apply:A.length?function(e,t){P.apply(e,j.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}function oe(e,t,r,i){var o,s,c,l,f,d,y,v=t&&t.ownerDocument,x=t?t.nodeType:9
if(r=r||[],"string"!=typeof e||!e||1!==x&&9!==x&&11!==x)return r
if(!i&&((t?t.ownerDocument||t:w)!==p&&h(t),t=t||p,m)){if(11!==x&&(f=X.exec(e)))if(o=f[1]){if(9===x){if(!(c=t.getElementById(o)))return r
if(c.id===o)return r.push(c),r}else if(v&&(c=v.getElementById(o))&&b(t,c)&&c.id===o)return r.push(c),r}else{if(f[2])return R.apply(r,t.getElementsByTagName(e)),r
if((o=f[3])&&n.getElementsByClassName&&t.getElementsByClassName)return R.apply(r,t.getElementsByClassName(o)),r}if(n.qsa&&!C[e+" "]&&(!g||!g.test(e))){if(1!==x)v=t,y=e
...
y=d.join(","),v=J.test(e)&&me(t.parentNode)||t}if(y)try{return R.apply(r,v.querySelectorAll(y)),r}catch(e){}finally{l===_&&t.removeAttribute("id")}}}return u(e.replace(U,"$1"),t,r,i)}function ae(){var e=[]
...
for(;a[r]===s[r];)r++
return r?le(a[r],s[r]):a[r]===w?-1:s[r]===w?1:0},p):p},oe.matches=function(e,t){return oe(e,null,null,t)},oe.matchesSelector=function(e,t){if((e.ownerDocument||e)!==p&&h(e),t=t.replace(V,"='$1']"),n.matchesSelector&&m&&!C[t+" "]&&(!y||!y.test(t))&&(!g||!g.test(t)))try{var r=v.call(e,t)
...
if(f=!n.detectDuplicates,l=!n.sortStable&&e.slice(0),e.sort(k),f){for(;t=e[o++];)t===e[o]&&(i=r.push(o))
...
if(!s){for(t||(t=a(e)),n=t.length;n--;)(s=xe(t[n]))[_]?i.push(s):o.push(s);(s=C(e,function(e,t){var n=t.length>0,i=e.length>0,o=function(o,a,s,u,l){var f,d,g,y=0,v="0",b=o&&[],_=[],w=c,E=o||i&&r.find.TAG("*",l),O=x+=null==w?1:Math.random()||.1,T=E.length
for(l&&(c=a===p||a||l);v!==T&&null!=(f=E[v]);v++){if(i&&f){for(d=0,a||f.ownerDocument===p||(h(f),s=!m);g=e[d++];)if(g(f,a||p,s)){u.push(f)
break}l&&(x=O)}n&&((f=!g&&f)&&y--,o&&b.push(f))}if(y+=v,n&&v!==y){for(d=0;g=t[d++];)g(b,_,a,s)
if(o){if(y>0)for(;v--;)b[v]||_[v]||(_[v]=M.call(u))
_=_e(_)}R.apply(u,_),l&&!o&&_.length>0&&y+t.length>1&&oe.uniqueSort(u)}return l&&(x=O,c=w),b}
...
h&&(t=t.parentNode),e=e.slice(u.shift().value.length)}for(o=G.needsContext.test(e)?0:u.length;o--&&(c=u[o],!r.relative[l=c.type]);)if((f=r.find[l])&&(i=f(c.matches[0].replace(Z,ee),J.test(u[0].type)&&me(t.parentNode)||t))){if(u.splice(o,1),!(e=i.length&&ye(u)))return R.apply(n,i),n
...
return t&&11!==t.nodeType?t:null},parents:function(e){return O(e,"parentNode")},parentsUntil:function(e,t,n){return O(e,"parentNode",n)},next:function(e){return N(e,"nextSibling")},prev:function(e){return N(e,"previousSibling")},nextAll:function(e){return O(e,"nextSibling")},prevAll:function(e){return O(e,"previousSibling")},nextUntil:function(e,t,n){return O(e,"nextSibling",n)},prevUntil:function(e,t,n){return O(e,"previousSibling",n)},siblings:function(e){return T((e.parentNode||{}).firstChild,e)},children:function(e){return T(e.firstChild)},contents:function(e){return k(e,"iframe")?e.contentDocument:(k(e,"template")&&(e=e.content||e),_.merge([],e.childNodes))}},function(e,t){_.fn[e]=function(n,r){var i=_.map(this,t,n)
return"Until"!==e.slice(-5)&&(r=n),r&&"string"==typeof r&&(i=_.filter(r,i)),this.length>1&&(j[e]||_.uniqueSort(i),R.test(e)&&i.reverse()),this.pushStack(i)}})
var D=/[^\x20\t\r\n\f]+/g
...
K.set(o,"hasDataAttrs",!0)}return i}return"object"==typeof e?this.each(function(){$.set(this,e)}):B(this,function(t){var n
...
function Ee(){return!0}function Oe(){return!1}function Te(){try{return r.activeElement}catch(e){}}function Ce(e,t,n,r,i,o){var a,s
...
var ke=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,Se=/<script|<style|<link/i,Ae=/checked\s*(?:[^=]|=\s*.checked.)/i,Me=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
function Pe(e,t){return k(e,"table")&&k(11!==t.nodeType?t:t.firstChild,"tr")&&_(e).children("tbody")[0]||e}function Re(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function je(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function Ne(e,t){var n,r,i,o,a,s,u,c
...
if(h&&(o=(i=ve(t,e[0].ownerDocument,!1,e,r)).firstChild,1===i.childNodes.length&&(i=o),o||r)){for(u=(s=_.map(pe(i,"script"),Re)).length;f<h;f++)c=i,f!==p&&(c=_.clone(c,!0,!0),u&&_.merge(s,pe(c,"script"))),n.call(e[f],c,f)
if(u)for(l=s[s.length-1].ownerDocument,_.map(s,je),f=0;f<u;f++)c=s[f],fe.test(c.type||"")&&!K.access(c,"globalEval")&&_.contains(l,c)&&(c.src&&"module"!==(c.type||"").toLowerCase()?_._evalUrl&&_._evalUrl(c.src):v(c.textContent.replace(Me,""),l,c))}return e}function Le(e,t,n){for(var r,i=t?_.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||_.cleanData(pe(r)),r.parentNode&&(n&&_.contains(r.ownerDocument,r)&&de(pe(r,"script")),r.parentNode.removeChild(r))
return e}_.extend({htmlPrefilter:function(e){return e.replace(ke,"<$1></$2>")},clone:function(e,t,n){var r,i,o,a,s,u,c,l=e.cloneNode(!0),f=_.contains(e.ownerDocument,e)
...
return(a=pe(l,"script")).length>0&&de(a,!f&&pe(e,"script")),l},cleanData:function(e){for(var t,n,r,i=_.event.special,o=0;void 0!==(n=e[o]);o++)if(G(n)){if(t=n[K.expando]){if(t.events)for(r in t.events)i[r]?_.event.remove(n,r):_.removeEvent(n,r,t.handle)
...
if("string"==typeof e&&!Se.test(e)&&!he[(le.exec(e)||["",""])[1].toLowerCase()]){e=_.htmlPrefilter(e)
...
return(n=n||Fe(e))&&(""!==(a=n.getPropertyValue(t)||n[t])||_.contains(e.ownerDocument,e)||(a=_.style(e,t)),!d.pixelBoxStyles()&&Ie.test(a)&&qe.test(t)&&(r=s.width,i=s.minWidth,o=s.maxWidth,s.minWidth=s.maxWidth=s.width=a,a=n.width,s.width=r,s.minWidth=i,s.maxWidth=o)),void 0!==a?a+"":a}function Ue(e,t){return{get:function(){if(!e())return(this.get=t).apply(this,arguments)
...
return i}},"margin"!==e&&(_.cssHooks[e+t].set=Ke)}),_.fn.extend({css:function(e,t){return B(this,function(e,t,n){var r,i,o={},a=0
...
for(var n,r=0,i=e.length;r<i;r++)n=e[r],st.tweeners[n]=st.tweeners[n]||[],st.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var r,i,o,a,s,u,c,l,f="width"in t||"height"in t,h=this,p={},d=e.style,m=e.nodeType&&re(e),g=K.get(e,"fxshow")
...
u===(i.ownerDocument||r)&&y.push(u.defaultView||u.parentWindow||e)}for(a=0;(s=y[a++])&&!t.isPropagationStopped();)d=s,t.type=a>1?c:p.bindType||v,(h=(K.get(s,"events")||{})[t.type]&&K.get(s,"handle"))&&h.apply(s,n),(h=l&&s[l])&&h.apply&&G(s)&&(t.result=h.apply(s,n),!1===t.result&&t.preventDefault())
...
var Ct=/%20/g,kt=/#.*$/,St=/([?&])_=[^&]*/,At=/^(.*?):[ \t]*([^\r\n]*)$/gm,Mt=/^(?:GET|HEAD)$/,Pt=/^\/\//,Rt={},jt={},Nt="*/".concat("*"),Dt=r.createElement("a")
...
return r&&_.extend(!0,e,r),e}Dt.href=vt.href,_.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:vt.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(vt.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Nt,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":_.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?Ft(Ft(e,_.ajaxSettings),t):Ft(_.ajaxSettings,e)},ajaxPrefilter:Lt(Rt),ajaxTransport:Lt(jt),ajax:function(t,n){"object"==typeof t&&(n=t,t=void 0),n=n||{}
...
var qt={0:200,1223:204},zt=_.ajaxSettings.xhr()
...
var T=function(){function e(t){(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),this.inner=t,this.tag=f}return e.prototype.value=function(){return this.inner},e}()
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):function(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)}(e,t))}var S,A=function(e){function t(n,r){C(this,t)
...
e.retained=!0,n.remove(e),n.insertBefore(e,t)},e.prototype.remove=function(e){this.list.remove(e),delete this.map[e.key]},e.prototype.nextNode=function(e){return this.list.nextNode(e)},e.prototype.head=function(){return this.list.head()},e}(),P=function(){function e(t){C(this,e),this.iterator=null
var n=new M(t)
...
e.ConstReference=T,e.isConst=function(e){return e.tag===f},e.ListItem=A,e.referenceFromParts=function(e,t){var n,r=e
for(n=0;n<t.length;n++)r=r.get(t[n])
return r},e.IterationArtifacts=M,e.ReferenceIterator=P,e.IteratorSynchronizer=R,e.CONSTANT=0,e.INITIAL=o,e.VOLATILE=NaN,e.RevisionTag=a,e.TagWrapper=c,e.CONSTANT_TAG=f,e.VOLATILE_TAG=h,e.CURRENT_TAG=p,e.DirtyableTag=m,e.combineTagged=function(e){var t,n,r,i=[]
...
function O(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var T=function(){function e(){O(this,e),this.stack=null,this.positional=new C,this.named=new S}return e.prototype.empty=function(){return this.setup(null,!0),this},e.prototype.setup=function(e,t){this.stack=e
...
return-1===r?m:this.stack.fromTop(n-r)},e.prototype.capture=function(){return new A(this.tag,this.names,this.references)},e.prototype.sliceName=function(e){return e.slice(1)},E(e,[{key:"tag",get:function(){return(0,n.combineTagged)(this.references)}},{key:"names",get:function(){var e=this._names
...
return i}}]),e}(),M=new T
function P(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function R(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
...
f&&e.newDestroyable(f),e.updateWith(new K(o,r,l))})
var K=function(e){function t(n,r,i){H(this,t)
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):function(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)}(e,t))}function Oe(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Te(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function Ce(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function ke(e){return"string"==typeof e}var Se=function e(t){Oe(this,e),this.bounds=t}
function Ae(e,n,r){if(ke(r))return Pe.insert(e,n,r)
if(Te(r))return je.insert(e,n,r)
if(Ce(r))return Ne.insert(e,n,r)
throw(0,t.unreachable)()}function Me(e,n,r){if(ke(r))return Re.insert(e,n,r)
if(Ce(r))return Ne.insert(e,n,r)
...
return e.insertBefore(n.element,i,n.nextSibling),new t(new ae(n.element,i),i)},t.prototype.update=function(e,t){return!!ke(t)&&(this.textNode.nodeValue=t,!0)},t}(Se),Re=function(e){function t(){return Oe(this,t),xe(this,e.apply(this,arguments))}return Ee(t,e),t.insert=function(e,n,r){return new t(e.insertHTMLBefore(n.element,n.nextSibling,r))},t.prototype.update=function(e,t){var n,r,i
return!!ke(t)&&(r=(n=this.bounds).parentElement(),i=ue(n),this.bounds=e.insertHTMLBefore(r,i,t),!0)},t}(Se),je=function(e){function t(n,r){Oe(this,t)
var i=xe(this,e.call(this,n))
return i.lastStringValue=r,i}return Ee(t,e),t.insert=function(e,n,r){var i=r.toHTML()
return new t(e.insertHTMLBefore(n.element,n.nextSibling,i),i)},t.prototype.update=function(e,t){var n,r,i,o
return!!Te(t)&&((n=t.toHTML())!==this.lastStringValue&&(i=(r=this.bounds).parentElement(),o=ue(r),this.bounds=e.insertHTMLBefore(i,o,n),this.lastStringValue=n),!0)},t}(Se),Ne=function(e){function t(){return Oe(this,t),xe(this,e.apply(this,arguments))}return Ee(t,e),t.insert=function(e,n,r){return e.insertBefore(n.element,r,n.nextSibling),new t(function(e,t){return new ae(e,t)}(n.element,r))},t.prototype.update=function(e,t){var n,r,i
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function Le(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):function(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)}(e,t))}function Ie(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function Fe(e){return null===e||void 0===e||"function"!=typeof e.toString}function qe(e){return Fe(e)?"":String(e)}function ze(e){return Fe(e)?"":ke(e)?e:Te(e)?e.toHTML():Ce(e)?e:String(e)}function Ue(e){return Fe(e)?"":ke(e)?e:Te(e)||Ce(e)?e:String(e)}s.add(26,function(e,t){var n=t.op1
...
return n.type="optimized-cautious-append",n}return Le(t,e),t.prototype.normalize=function(e){return(0,n.map)(e,Ue)},t.prototype.insert=function(e,t,n){return Ae(e,t,n)},t.prototype.updateWith=function(e,t,n,r,i){return new Ye(n,r,i)},t}(Be),Ye=function(e){function t(){Ie(this,t)
var n=De(this,e.apply(this,arguments))
return n.type="optimized-cautious-update",n}return Le(t,e),t.prototype.insert=function(e,t,n){return Ae(e,t,n)},t}(Ve),Ge=function(e){function t(){Ie(this,t)
var n=De(this,e.apply(this,arguments))
return n.type="optimized-trusting-append",n}return Le(t,e),t.prototype.normalize=function(e){return(0,n.map)(e,ze)},t.prototype.insert=function(e,t,n){return Me(e,t,n)},t.prototype.updateWith=function(e,t,n,r,i){return new Qe(n,r,i)},t}(Be),Qe=function(e){function t(){Ie(this,t)
var n=De(this,e.apply(this,arguments))
return n.type="optimized-trusting-update",n}return Le(t,e),t.prototype.insert=function(e,t,n){return Me(e,t,n)},t}(Ve)
function Ke(e,t){console.info("Use `context`, and `get(<path>)` to debug this template."),t("this")}var $e=Ke,Xe=function(){function e(n,r,i){var o,a,s,u
...
this.fetch(a.s0),this.dup(a.sp,1),this.load(a.s0),this.pushBlock(r),this.pushBlock(i),this.compileArgs(t,n,!1),this.prepareArgs(a.s0),this.beginComponentTransaction(),this.pushDynamicScope(),this.createComponent(a.s0,null!==r,null!==i),this.registerComponentDestructor(a.s0),this.getComponentSelf(a.s0),this.getComponentLayout(a.s0),this.invokeDynamic(new Tt(e&&e.scan())),this.popFrame(),this.popScope(),this.popDynamicScope(),this.commitComponentTransaction(),this.load(a.s0)},n.prototype.template=function(e){return e?new ht(this.meta,e.statements,e.parameters):null},n}(function(){function e(n,r,i){mt(this,e),this.env=n,this.meta=r,this.program=i,this.labelsStack=new t.Stack,this.constants=i.constants,this.heap=i.heap,this.start=this.heap.malloc()}return e.prototype.upvars=function(e){return(0,t.fillNulls)(e)},e.prototype.reserve=function(e){this.push(e,0,0,0)},e.prototype.push=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0
...
var Tt=function(){function e(t){vt(this,e),this.attrs=t}return e.prototype.invoke=function(e,n){var r,i,o,a=n.symbolTable,s=a.symbols,u=a.hasEval,c=e.stack,l=e.pushRootScope(s.length+1,!0)
...
n.closeElement()}})
var Ct=function(){function e(t,n){vt(this,e),this.outerSymbols=t,this.evalInfo=n}return e.prototype.invoke=function(e,t){var n,r,i,o,a,s,u,c=t,l=c.symbolTable.symbols,f=e.scope(),h=f.getEvalScope(),p=e.pushRootScope(l.length,!1)
...
var kt=function(){function e(t){vt(this,e),this.callerCount=t}return e.prototype.invoke=function(e,t){var n,r=this.callerCount,i=e.stack
...
var St=new wt,At=new wt(1),Mt=r.Expressions
function Pt(e,t){Array.isArray(e)?St.compile(e,t):t.primitive(e)}function Rt(e,t){var n
if(!e)return 0
...
t.concat(r.length)}),At.add(Je.FunctionExpression,function(e,t){t.function(e[2])}),St.add(bt.Helper,function(e,t){var n=t.env,r=t.meta,i=e[1],o=e[2],a=e[3]
if(!n.hasHelper(i,r.templateMeta))throw new Error("Compile Error: "+i+" is not a helper")
t.compileArgs(o,a,!0),t.helper(n.lookupHelper(i,r.templateMeta))}),St.add(bt.Get,function(e,t){var n,r=e[1],i=e[2]
...
var jt=function(){function e(){vt(this,e),this.names=(0,t.dict)(),this.funcs=[]}return e.prototype.add=function(e,t){this.funcs.push(t),this.names[e]=this.funcs.length-1},e.prototype.addMissing=function(e){this.missing=e},e.prototype.compile=function(e,n,r,i,o,a){var s,u=this.names[e]
void 0===u?((0,t.assert)(!!this.missing,e+" not found, and no catch-all block handler was registered"),s=(0,this.missing)(e,n,r,i,o,a),(0,t.assert)(!!s,e+" not found, and the catch-all block handler didn't handle it")):(0,this.funcs[u])(n,r,i,o,a)},e}(),Nt=new jt,Dt=function(){function e(){vt(this,e),this.names=(0,t.dict)(),this.funcs=[]}return e.prototype.add=function(e,t){this.funcs.push(t),this.names[e]=this.funcs.length-1},e.prototype.addMissing=function(e){this.missing=e},e.prototype.compile=function(e,t){var n,r,i=e[1]
...
t?(o=t[0],Rt(t[1],i),i.pushDynamicScope(),i.bindDynamicScope(o),i.invokeStatic(n),i.popDynamicScope()):i.invokeStatic(n)}),{blocks:e,inlines:t}}function It(e,t){xt.compile(e,t)}Lt(Nt,new Dt)
...
var qt=r.Ops,zt=function(){function e(t,n){(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),this.block=t,this.env=n}return e.prototype.scanEntryPoint=function(e){var t=this.block,n=t.statements,r=t.symbols,i=t.hasEval
return new Ft(n,{meta:e,symbols:r,hasEval:i})},e.prototype.scanBlock=function(e){var n=this.block.statements
return new Ft(n,{meta:e,parameters:t.EMPTY_ARRAY})},e.prototype.scanLayout=function(e,t,n){var i,o,a,s=this.block,u=s.statements,c=s.symbols,l=s.hasEval,f=[],h=void 0,p=!1
for(i=0;i<u.length;i++)if(o=u[i],r.Statements.isComponent(o))a=o[1],this.env.hasComponentDefinition(a,e.templateMeta)?void 0===h&&a===n?(h=a,Bt(a,c,t,f),Ut(o,f)):f.push(o):(void 0!==h?f.push([qt.OpenElement,a]):(h=a,Bt(a,c,t,f)),Ut(o,f))
...
f.push(o)}return f.push([qt.ClientSideStatement,Je.DidRenderLayout]),new Ft(f,{meta:e,hasEval:l,symbols:c})},e}()
function Ut(e,t){var n,r,i,o=e[2],a=e[4]
for(n=0;n<o.length;n++)t.push(o[n])
if(t.push([qt.FlushElement]),a)for(r=a.statements,i=0;i<r.length;i++)t.push(r[i])
t.push([qt.CloseElement])}function Bt(e,n,r,i){var o=n.push(_t)
...
return this.others.push(e),t+1},e}(),Vt=["javascript:","vbscript:"],Wt=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],Yt=["EMBED"],Gt=["href","src","background","action"],Qt=["src"]
function Kt(e,t){return-1!==e.indexOf(t)}function $t(e,t){return(null===e||Kt(Wt,e))&&Kt(Gt,t)}function Xt(e,t){return null!==e&&(Kt(Yt,e)&&Kt(Qt,t))}function Jt(e,t){return $t(e,t)||Xt(e,t)}function Zt(e,t,n,r){var i,o=null
if(null===r||void 0===r)return r
if(Te(r))return r.toHTML()
o=t?t.tagName.toUpperCase():null
var a=qe(r)
return $t(o,n)&&(i=e.protocolForURL(a),Kt(Vt,i))?"unsafe:"+a:Xt(o,n)?"unsafe:"+a:a}function en(e,t){var n,r,i,o,a=void 0,s=void 0
...
var n,r,i=t
r=i,i=(n=Tn)&&yn(n)?function(e){function t(n){dn(this,t)
...
return void 0===a?e.prototype.insertHTMLBefore.call(this,t,r,i):sn(t,a,n,i,r)},t}(t)}(Tn,i),i=function(e,t,n){if(!e)return t
if(!pn(e,n))return t
var r=e.createElement("div")
return function(e){function t(){return cn(this,t),ln(this,e.apply(this,arguments))}return fn(t,e),t.prototype.insertHTMLBefore=function(t,i,o){return null===o||""===o?e.prototype.insertHTMLBefore.call(this,t,i,o):t.namespaceURI!==n?e.prototype.insertHTMLBefore.call(this,t,i,o):hn(t,r,o,i)},t}(t)}(Tn,i,wn),e.DOMTreeConstruction=i})(kn||(kn={}))
...
return new oe(i,c,u)}var Pn,Rn=An
Pn=Rn,Rn=Tn&&yn(Tn)?function(e){function t(n){dn(this,t)
var r=mn(this,e.call(this,n))
...
o&&o instanceof Text&&(i=!0,t.insertBefore(this.uselessComment,n))
var a=e.prototype.insertHTMLBefore.call(this,t,n,r)
return i&&t.removeChild(this.uselessComment),a},t}(Pn):Pn,Rn=function(e,t){if(!e)return t
if(!un(e))return t
var n=e.createElement("div")
return function(e){function t(){return nn(this,t),rn(this,e.apply(this,arguments))}return on(t,e),t.prototype.insertHTMLBefore=function(t,r,i){if(null===i||""===i)return e.prototype.insertHTMLBefore.call(this,t,r,i)
var o=t.tagName.toLowerCase(),a=an[o]
return void 0===a?e.prototype.insertHTMLBefore.call(this,t,r,i):sn(t,a,n,i,r)},t}(t)}(Tn,Rn)
var jn=Rn=function(e,t,n){if(!e)return t
if(!pn(e,n))return t
var r=e.createElement("div")
return function(e){function t(){return cn(this,t),ln(this,e.apply(this,arguments))}return fn(t,e),t.prototype.insertHTMLBefore=function(t,i,o){return null===o||""===o?e.prototype.insertHTMLBefore.call(this,t,i,o):t.namespaceURI!==n?e.prototype.insertHTMLBefore.call(this,t,i,o):hn(t,r,o,i)},t}(t)}(Tn,Rn,wn),Nn=kn.DOMTreeConstruction
...
r.selected=!!n},t}(Bn))("selected"),Gn=function(e){function t(){return In(this,t),Dn(this,e.apply(this,arguments))}return Ln(t,e),t.prototype.setAttribute=function(t,n,r){e.prototype.setAttribute.call(this,t,n,Zt(t,n,this.attr,r))},t.prototype.updateAttribute=function(t,n,r){e.prototype.updateAttribute.call(this,t,n,Zt(t,n,this.attr,r))},t}(Un),Qn=function(){function e(e,t){var n,r
for(n=0;n<t.length;n++)(r=t[n]).enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}()
function Kn(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var $n,Xn=function(){function e(t,n,r,i){Kn(this,e),this.slots=t,this.callerScope=n,this.evalScope=r,this.partialMap=i}return e.root=function(t){var n,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,i=new Array(r+1)
for(n=0;n<=r;n++)i[n]=m
...
for(u=0;u<v.length;u++)c=v[u],l=b[u],c.update(l)},e}(),Zn=function(){function e(t){Kn(this,e),this.heap=t,this.offset=0}return Qn(e,[{key:"type",get:function(){return this.heap.getbyaddr(this.offset)}},{key:"op1",get:function(){return this.heap.getbyaddr(this.offset+1)}},{key:"op2",get:function(){return this.heap.getbyaddr(this.offset+2)}},{key:"op3",get:function(){return this.heap.getbyaddr(this.offset+3)}}]),e}();(function(e){e[e.Allocated=0]="Allocated",e[e.Freed=1]="Freed",e[e.Purged=2]="Purged",e[e.Pointer=3]="Pointer"})($n||($n={}))
...
this.offset=this.offset-o},e}(),tr=function(){function e(){Kn(this,e),this.heap=new er,this._opcode=new Zn(this.heap),this.constants=new Ht}return e.prototype.opcode=function(e){return this._opcode.offset=e,this._opcode},e}(),nr=function(){function e(t){var n=t.appendOperations,r=t.updateOperations
...
return e.compile(n),n.compile()},e.CompiledStaticTemplate=nt,e.CompiledDynamicTemplate=rt,e.IAttributeManager=Un,e.AttributeManager=Un,e.PropertyManager=Bn,e.INPUT_VALUE_PROPERTY_MANAGER=Wn,e.defaultManagers=Fn,e.defaultAttributeManagers=zn,e.defaultPropertyManagers=qn,e.readDOMAttr=function(e,t){var n=e.namespaceURI===wn,r=en(e,t),i=r.type,o=r.normalized
return n?e.getAttribute(o):"attr"===i?e.getAttribute(o):e[o]},e.Register=a,e.debugSlice=function(){},e.normalizeTextValue=qe,e.setDebuggerCallback=function(e){$e=e},e.resetDebuggerCallback=function(){$e=Ke},e.getDynamicVar=function(e,t){var n=e.dynamicScope(),r=t.positional.at(0)
return new Er(n,r)},e.BlockMacros=jt,e.InlineMacros=Dt,e.compileList=Rt,e.compileExpression=Pt,e.UpdatingVM=sr,e.RenderResult=pr
e.isSafeString=Te,e.Scope=Xn,e.Environment=nr,e.PartialDefinition=function e(t,n){(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),this.name=t,this.template=n},e.ComponentDefinition=function e(t,n,r){(function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")})(this,e),this[_e]=!0,this.name=t,this.manager=n,this.ComponentClass=r},e.isComponentDefinition=we,e.DOMChanges=jn,e.IDOMChanges=An,e.DOMTreeConstruction=Nn,e.isWhitespace=function(e){return On.test(e)},e.insertHTMLBefore=Mn,e.ElementStack=me,e.ConcreteBounds=oe}),e("@glimmer/util",["exports"],function(e){"use strict"
...
return n},e.ensureGuid=m,e.initializeGuid=d,e.Stack=w,e.DictSet=_,e.dict=b,e.EMPTY_SLICE=T,e.LinkedList=E,e.ListNode=function e(t){x(this,e),this.next=null,this.prev=null,this.value=t},e.ListSlice=O,e.A=k,e.EMPTY_ARRAY=S,e.HAS_NATIVE_WEAKMAP=C,e.unwrap=function(e){if(null===e||void 0===e)throw new Error("Expected value to be present")
...
return(0,o.guidFor)(t)+"|"+e.id})},function(e){return e.id}),u.builtInModifiers={action:new S.default},u.builtInHelpers={if:x.inlineIf,action:g.default,concat:v.default,get:_.default,hash:w.default,log:E.default,mut:O.default,"query-params":T.default,readonly:C.default,unbound:k.default,unless:x.inlineUnless,"-class":h.default,"-each-in":b.default,"-input-type":d.default,"-normalize-class":m.default,"-html-safe":p.default,"-get-dynamic-var":n.getDynamicVar},u}return(0,t.inherits)(r,e),r.create=function(e){return new this(e)},r.prototype.protocolForURL=function(e){return e},r.prototype._resolveLocalLookupName=function(e,t,n){return n._resolveLocalLookupName(e,t)},r.prototype.macros=function(){var t=e.prototype.macros.call(this)
...
function E(){return new o.DirtyableTag}function O(e,t){return"object"==typeof e&&null!==e?(void 0===t?ye(e):t).writableTag(E):o.CONSTANT_TAG}function T(e,t){var n=e.readableTag()
void 0!==n&&n.dirty()
...
var k=function(){function e(){this.clear()}return e.prototype.add=function(e,t,r){var i=this.observerSet,o=this.observers,a=n.guidFor(e),s=i[a]
void 0===s&&(i[a]=s={})
var u=s[t]
...
for(this.clear(),e=0;e<t.length;++e)(r=(n=t[e]).sender).isDestroying||r.isDestroyed||_(r,n.eventName,[r,n.keyName],n.listeners)},e.prototype.clear=function(){this.observerSet={},this.observers=[]},e}(),S=0
function A(e){return"object"==typeof e&&null!==e||"function"==typeof e}var M=function(){function t(e){var t,r,i,o
if(this._id=n.GUID_KEY+S++,null===e||void 0===e);else{if(!Array.isArray(e))throw new TypeError("The weak map constructor polyfill only supports an array argument")
...
var R=n.symbol("PROPERTY_DID_CHANGE"),j=new k,N=new k,D=0
...
D>0?(i=N.add(e,t,r),G(e,r,i,n)):_(e,r,[e,t])}(t,n,i)),t[R]&&t[R](n),o){if(i.isSourceDestroying())return
T(i,n)}}}var F,q=void 0,z=void 0
...
void 0!==r&&r.revalidate(t)}function H(){D++}function V(){--D<=0&&(j.clear(),N.flush())}function W(e,t){H()
...
return c}}function Q(){this.isDescriptor=!0}function K(e,t,n,r,i){void 0===i&&(i=ye(e))
...
t&&void 0!==t._computedProperties&&(t._computedProperties=void 0)}(e.constructor),"function"==typeof n.setup&&n.setup(e,t)):void 0===n||null===n?(u=r,e[t]=r):(u=n,Object.defineProperty(e,t,n)),a&&B(0,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,u),this}F=Object.create(Object.prototype,{prop:{configurable:!0,value:1}}),Object.defineProperty(F,"prop",{configurable:!0,value:2}),F.prop
var $=!1
...
if(function(e){return!(ie(e)&&e.isDescriptor&&!1===e._volatile)}(t[n]))return Se(t,n)
...
function Te(e){return we.get(e)}function Ce(e){return-1!==xe.get(e)}var ke={object:!0,function:!0,string:!0}
function Se(e,t){var n=e[t]
...
if((r=Se(r,i[n]))&&r.isDestroyed)return}return r}function Me(e){return void 0!==e&&null!==e&&ke[typeof e]}function Pe(t,n,i,o){if(Ce(n))return function(e,t,n,i){var o=t.split("."),a=o.pop()
var s=o.join("."),u=Ae(e,s)
...
var a,s=t[n]
return null!==s&&"object"==typeof s&&s.isDescriptor?s.set(t,n,i):void 0!==s||"object"!=typeof t||n in t||"function"!=typeof t.setUnknownProperty?s!==i&&(L(t,n,a=e.peekMeta(t)),t[n]=i,I(t,n,a)):t.setUnknownProperty(n,i),i}function Re(e,t,n){return Pe(e,t,n,!0)}var je=/\.@each$/
function Ne(e,t){var n=e.indexOf("{")
n<0?t(e.replace(je,".[]")):function e(t,n,r,i){var o=n.indexOf("}"),a=0,s=void 0,u=void 0
var c=n.substring(r+1,o).split(",")
var l=n.substring(o+1)
t+=n.substring(0,r)
u=c.length
for(;a<u;)(s=l.indexOf("{"))<0?i((t+c[a++]+l).replace(je,".[]")):e(t+c[a++],l,s,i)}("",e,n,t)}function De(e,t,n){Ce(t)?ee(e,t,n):X(e,t,n)}function Le(t,n){var r=e.peekMeta(t)
return void 0!==r&&r.peekWatching(n)||0}function Ie(e,t,n){Ce(t)?te(e,t,n):J(e,t,n)}function Fe(e,t,n,r){var i,o,a=e._dependentKeys
if(null!==a&&void 0!==a)for(i=0;i<a.length;i++)o=a[i],r.writeDeps(o,n,(r.peekDeps(o,n)||0)+1),De(t,o,r)}function qe(e,t,n,r){var i,o,a=e._dependentKeys
...
n?this._getter=e:(this._getter=e.get,this._setter=e.set),this._suspended=void 0,this._meta=void 0,this._volatile=!1,this._dependentKeys=t&&t.dependentKeys,this._readOnly=t&&n&&!0===t.readOnly}ze.prototype=new Q,ze.prototype.constructor=ze
var Ue=ze.prototype
...
return a&&s===u?u:(L(e,t,r),a||Fe(this,e,t,r),i[t]=void 0===u?le:u,I(e,t,r),u)},Ue.teardown=function(e,t,n){if(!this._volatile){var r=n.readableCache()
void 0!==r&&void 0!==r[t]&&(qe(this,e,t,n),r[t]=void 0)}},Be.set=function(e,t,n){e[t]=void 0===n?le:n},Be.get=function(e,t){var n=e[t]
...
n.peekWatching(t)&&Fe(this,e,t,n)},t.prototype.teardown=function(e,t,n){n.peekWatching(t)&&qe(this,e,t,n)},t.prototype.willWatch=function(e,t,n){Fe(this,e,t,n)},t.prototype.didUnwatch=function(e,t,n){qe(this,e,t,n)},t.prototype.get=function(e,t){var n=Se(e,this.altKey),r=ye(e),i=r.writableCache()
return i[t]!==He&&(i[t]=He,Fe(this,e,t,r)),n},t.prototype.set=function(e,t,n){return Pe(e,this.altKey,n)},t.prototype.readOnly=function(){return this.set=We,this},t.prototype.oneWay=function(){return this.set=Ye,this},t}(Q)
function We(e,t){throw new r.Error("Cannot set read-only property '"+t+"' on object: "+n.inspect(e))}function Ye(e,t,n){return K(e,t,null),Pe(e,t,n)}Ve.prototype._meta=void 0,Ve.prototype.meta=ze.prototype.meta
var Ge=[],Qe={}
var Ke,$e,Xe=(Ke="undefined"!=typeof window&&window.performance||{},($e=Ke.now||Ke.mozNow||Ke.webkitNow||Ke.msNow||Ke.oNow)?$e.bind(Ke):function(){return+new Date})
...
var i=typeof e
return"object"===i&&"number"==typeof(t=Se(e,"size"))?!t:"number"==typeof e.length&&"function"!==i?!e.length:"object"===i&&"number"==typeof(n=Se(e,"length"))&&!n}function ot(e){return it(e)||"string"==typeof e&&!1===/\S/.test(e)}var at=new u(["sync","actions","destroy"],{GUID_KEY:n.GUID_KEY,sync:{before:H,after:V},defaultQueue:"actions",onBegin:function(e){st.currentRunLoop=e},onEnd:function(e,t){st.currentRunLoop=t},onErrorTarget:tt,onErrorMethod:"onerror"})
...
return Te(this._from)&&(r=this._from,n=Ee.get(r),(a=t.context.lookup[n])&&(i=a,o=function(e){return Oe.get(e)}(this._from))),void 0===i&&(i=e,o=this._from),Re(e,this._to,Se(i,o)),yt(i,o,this,"fromDidChange"),this._oneWay||yt(e,this._to,this,"toDidChange"),g(e,"willDestroy",this,"disconnect"),this._to,this._from,this._oneWay,!a&&this._oneWay,this._readyToSync=!0,this._fromObj=i,this._fromPath=o,this._toObj=e,this},e.prototype.disconnect=function(){return vt(this._fromObj,this._fromPath,this,"fromDidChange"),this._oneWay||vt(this._toObj,this._to,this,"toDidChange"),this._readyToSync=!1,this},e.prototype.fromDidChange=function(){this._scheduleSync("fwd")},e.prototype.toDidChange=function(){this._scheduleSync("back")},e.prototype._scheduleSync=function(e){var t=this._direction
...
this._direction=void 0,"fwd"===o?(e=Se(a,u),r&&s.log(" ",this.toString(),"->",e,a),this._oneWay?Re(i,this._to,e):_t(i,this._to,this,"toDidChange",function(){Re(i,this._to,e)})):"back"===o&&(n=Se(i,this._to),r&&s.log(" ",this.toString(),"<-",n,i),_t(a,u,this,"fromDidChange",function(){Re(a,u,n)}))}},e}();(function(e,t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])})(xt,{from:function(e){return new this(void 0,e)},to:function(e){return new this(e,void 0)}})
var Et=Array.prototype.concat,Ot=Array.isArray
function Tt(e){return"function"==typeof e&&!1!==e.isMethod&&e!==Boolean&&e!==Object&&e!==Number&&e!==Array&&e!==Date&&e!==String}var Ct={}
function kt(e,t,n,r){var i=n[e]||r[e]
return t[e]&&(i=i?Et.call(i,t[e]):t[e]),i}function St(e,t,r,i,o){var a=void 0
return void 0===o[t]&&(a=i[t]),void 0===(a=a||e[t])||"function"!=typeof a?r:n.wrap(r,a)}function At(e,t,r,i,o,a,s,u){if(r instanceof Q){if(r===qt&&o[t])return Ct
...
for(var c in r)r.hasOwnProperty(c)&&(Tt(o=r[c])?(u=!0,s[c]=St(e,c,o,a,{})):s[c]=o)
return u&&(s._super=n.ROOT),s}(e,t,r,a):Tt(r)&&(r=St(e,t,r,a,o)),o[t]=void 0,a[t]=r}function Mt(e){var t=e.length
...
return n[i]||r[i]?(o=r[i],t=n[i]):(a=e[i])&&null!==a&&"object"==typeof a&&a.isDescriptor?(t=a,o=void 0):(t=void 0,o=e[i]),{desc:t,value:o}}function jt(e,t,n,r){var i
if(n)for(i=0;i<n.length;i++)r(e,n[i],null,t)}function Nt(e,t,n){var r=e[t]
"function"==typeof r&&(jt(e,t,r.__ember_observesBefore__,wt),jt(e,t,r.__ember_observes__,vt),jt(e,t,r.__ember_listens__,y)),"function"==typeof n&&(jt(e,t,n.__ember_observesBefore__,bt),jt(e,t,n.__ember_observes__,yt),jt(e,t,n.__ember_listens__,g))}function Dt(e,t,r){var i,o,a={},s={},u=ye(e),c=[],l=void 0,f=void 0,h=void 0
for(e._super=n.ROOT,function e(t,r,i,o,a,s){var u,c,l,f,h=void 0,p=void 0,d=void 0,m=void 0,g=void 0
function y(e){delete i[e],delete o[e]}for(u=0;u<t.length;u++)if(h=t[u],c=r,f=void 0,f=void 0,(p=(l=h)instanceof Lt?(f=n.guidFor(l),c.peekMixins(f)?Ct:(c.writeMixins(f,l),l.properties)):l)!==Ct)if(p){for(d in a.willMergeMixin&&a.willMergeMixin(p),m=kt("concatenatedProperties",p,o,a),g=kt("mergedProperties",p,o,a),p)p.hasOwnProperty(d)&&(s.push(d),At(a,d,p[d],0,i,o,m,g))
p.hasOwnProperty("toString")&&(a.toString=p.toString)}else h.mixins&&(e(h.mixins,r,i,o,a,s),h._without&&h._without.forEach(y))}(t,u,a,s,e,c),i=0;i<c.length;i++)if("constructor"!==(l=c[i])&&s.hasOwnProperty(l)&&(h=a[l],f=s[l],h!==qt)){for(;h&&h instanceof zt;)h=(o=Rt(e,h,a,s)).desc,f=o.value
void 0===h&&void 0===f||(Nt(e,l,f),Mt(l)&&u.writeBindings(l,f),K(e,l,h,f,u))}return r||Pt(e,u),e}Mt("notbound"),Mt("fooBinding")
...
return r.lookup(t.type+":"+(t.name||e))}qt.toString=function(){return"(Required Property)"},zt.prototype=new Q,Bt.prototype=Object.create(Q.prototype)
...
return e},e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){Pe(this,n,e)},get:function(){return Se(this,n)}})},e.instrument=function(e,t,n,r){if(arguments.length<=3&&"function"==typeof t&&(r=n,n=t,t=void 0),0===Ge.length)return n.call(r)
...
return Ge.push(a),Qe={},a},e.instrumentationUnsubscribe=function(e){var t,n=void 0
...
void 0!==n&&n.destroy()},e.Cache=ve,e._getPath=Ae,e.get=Se,e.getWithDefault=function(e,t,n){var r=Se(e,t)
return void 0===r?n:r},e.set=Pe,e.trySet=Re,e.WeakMap=P,e.WeakMapPolyfill=M,e.addListener=g,e.hasListeners=function(t,n){var r=e.peekMeta(t)
...
return void 0!==n?n.watchedEvents():[]},e.isNone=rt,e.isEmpty=it,e.isBlank=ot,e.isPresent=function(e){return!ot(e)},e.run=st,e.ObserverSet=k,e.beginPropertyChanges=H,e.changeProperties=W,e.endPropertyChanges=V,e.overrideChains=B,e.propertyDidChange=I,e.propertyWillChange=L,e.PROPERTY_DID_CHANGE=R,e.defineProperty=K,e.Descriptor=Q,e._hasCachedComputedProperties=function(){$=!0},e.watchKey=X,e.unwatchKey=J,e.ChainNode=ce,e.finishChains=function(e){var t=e.readableChainWatchers()
...
for(t=arguments.length,n=Array(t>1?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return Dt(e,n,!1),e},e.observer=Ut,e.required=function(){return qt},e.REQUIRED=qt,e.hasUnprocessedMixins=function(){return Ft},e.clearUnprocessedMixins=function(){Ft=!1},e.detectBinding=Mt,e.Binding=xt
e.bind=function(e,t,n){return new xt(t,n).connect(e)},e.isGlobalPath=Te,e.InjectedProperty=Bt,e.setHasViews=function(e){x=e},e.tagForProperty=function(e,t,n){if("object"!=typeof e||null===e)return o.CONSTANT_TAG
var r=void 0===n?ye(e):n
if(r.isProxy())return O(e,r)
var i=r.writableTags(),a=i[t]
return a||(i[t]=E())},e.tagFor=O,e.markObjectAsDirty=T,e.replace=function(e,t,n,r){for(var i=[].concat(r),o=[],a=t,s=n,u=void 0,c=void 0;i.length;)(u=s>6e4?6e4:s)<=0&&(u=0),c=i.splice(0,6e4),c=[a,u].concat(c),a+=6e4,s-=u,o=o.concat(Gt.apply(e,c))
...
var x=[],E={},O=[]
for(var T in g)g.hasOwnProperty(T)&&"unknownProperty"!==T&&"_super"!==T&&(u=void 0,"controller"===(s=(r=g[T]).scope||"model")&&(u=[]),c=r.as||this.serializeQueryParamKey(T),l=(0,n.get)(b,T),Array.isArray(l)&&(l=(0,i.A)(l.slice())),f=r.type||(0,i.typeOf)(l),h=this.serializeQueryParam(l,c,f),p=y+":"+T,d={undecoratedDefaultValue:(0,n.get)(b,T),defaultValue:l,serializedDefaultValue:h,serializedValue:h,type:f,urlKey:c,prop:T,scopedPropertyName:p,controllerName:y,route:this,parts:u,values:null,scope:s},E[T]=E[c]=E[p]=d,x.push(d),O.push(T))
...
0===n.length&&(r=k(f,l,c)),l=r}f&&(this._toplevelView?this._toplevelView.setOutletState(f):(s=(a=(0,t.getOwner)(this)).factoryFor("view:-outlet"),this._toplevelView=s.create(),this._toplevelView.setOutletState(f),a.lookup("-application-instance:main").didCreateRootView(this._toplevelView)))}}},willTransition:function(e,t,n){r.run.once(this,this.trigger,"willTransition",n)},handleURL:function(e){var t=e.split(/#(.+)?/)[0]
...
default:return e[t].apply(e,n)}}function x(e,t){return null!==e&&void 0!==e&&"function"==typeof e[t]}var E=Array.isArray,O=l("NAME_KEY"),T=Object.prototype.toString
function C(e){return null===e||void 0===e}var k=function(){if(!("function"==typeof WeakMap))return!1
var e=new WeakMap
...
return r}return null!=t&&"function"==typeof t.toString?t.toString():T.call(t)},e.HAS_NATIVE_WEAKMAP=k,e.HAS_NATIVE_PROXY=S}),e("ember-views/compat/attrs",["exports","ember-utils"],function(e,t){"use strict"
...
return S.ENCODE_AND_DECODE_PATH_SEGMENTS?f(n):n},v[2]=function(e,t){return m(t,e.value)},v[4]=function(){return""}
...
function O(e,t){return e.negate?e.char!==t&&-1!==e.char:e.char===t||-1===e.char}function T(e,t){var n,r,i,o=[]
...
S.prototype.add=function(e,t){var n,r,i,o,a,s,u,c=this.rootState,l="^",f=[0,0,0],h=new Array(e.length),p=[],d=!0,m=0
...
h[n]={handler:r.handler,names:o,shouldDecodes:a}}d&&(c=c.put(47,!1,!1),l+="/"),c.handlers=h,c.pattern=l+"$",c.types=f,"object"==typeof t&&null!==t&&t.as&&(u=t.as),u&&(this.names[u]={segments:p,handlers:h})},S.prototype.handlersFor=function(e){var t,n,r=this.names[e]
...
return u},S.prototype.recognize=function(e){var t,n,r,i,o=[this.rootState],a={},u=!1,c=e.indexOf("#");-1!==c&&(e=e.substr(0,c))
var l=e.indexOf("?");-1!==l&&(n=e.substr(l+1,e.length),e=e.substr(0,l),a=this.parseQueryString(n)),"/"!==e.charAt(0)&&(e="/"+e)
var f=e
S.ENCODE_AND_DECODE_PATH_SEGMENTS?e=s(e):(e=decodeURI(e),f=decodeURI(f))
var h=e.length
for(h>1&&"/"===e.charAt(h-1)&&(e=e.substr(0,h-1),f=f.substr(0,f.length-1),u=!0),r=0;r<e.length&&(o=T(o,e.charCodeAt(r))).length;r++);var p=[]
...
var d=t.match(p),m=1,g=new C(n)
for(g.length=h.length,r=0;r<h.length;r++){if(o=(i=h[r]).names,a=i.shouldDecodes,s=b,u=!1,o!==_&&a!==_)for(c=0;c<o.length;c++)u=!0,l=o[c],f=d&&d[m++],s===b&&(s={}),S.ENCODE_AND_DECODE_PATH_SEGMENTS&&a[c]?s[l]=f&&decodeURIComponent(f):s[l]=f
g[r]={handler:i.handler,params:s,isDynamic:u}}return g}(d,f,a)),t},S.VERSION="0.3.3",S.ENCODE_AND_DECODE_PATH_SEGMENTS=!0,S.Normalizer={normalizeSegment:c,normalizePath:s,encodePathSegment:f},S.prototype.map=function(e,t){var n=new i
e(o("",n,this.delegate)),function e(t,n,r,i){var o,s,u,c,l=n.routes,f=Object.keys(l)
for(o=0;o<f.length;o++)s=f[o],a(u=t.slice(),s,l[s]),(c=n.children[s])?e(u,c,r,i):r.call(i,u)}([],n,function(e){t?t(this,e):this.add(e)},this)},e.default=S}),e("router",["exports","ember-babel","route-recognizer","rsvp"],function(e,t,n,r){"use strict"
e.Transition=void 0
...
return n.factory=k,n}k.klasses={resolved:O,param:C,object:T}
...
u=(c=this.preTransitionState.handlerInfos[a])&&c.context}return k("object",{name:e,getHandler:t,serializer:s,context:u,names:n})},n.prototype.createParamHandlerInfo=function(e,t,n,r,i){for(var o,a,s,u={},c=n.length;c--;)if(o=i&&e===i.name&&i.params||{},a=r[r.length-1],s=n[c],l(a))u[s]=""+r.pop()
...
return e}for(u=0,c=f.length;u<c;++u)(o=(i=k("param",{name:(r=f[u]).handler,getHandler:n,params:r.params})).handler)?d(o):i.handlerPromise=i.handlerPromise.then(d),s=e.handlerInfos[u],h||i.shouldSupercede(s)?(h=!0,l.handlerInfos[u]=i):l.handlerInfos[u]=s
return a(l.queryParams,f.queryParams),l},n}(w),P=Array.prototype.pop
function R(e){var t=e||{}
this.getHandler=t.getHandler||this.getHandler,this.getSerializer=t.getSerializer||this.getSerializer,this.updateURL=t.updateURL||this.updateURL,this.replaceURL=t.replaceURL||this.replaceURL,this.didTransition=t.didTransition||this.didTransition,this.willTransition=t.willTransition||this.willTransition,this.delegate=t.delegate||this.delegate,this.triggerEvent=t.triggerEvent||this.triggerEvent,this.log=t.log||this.log,this.dslCallBacks=[],this.state=void 0,this.activeTransition=void 0,this._changedQueryParams=void 0,this.oldState=void 0,this.currentHandlerInfos=void 0,this.currentSequence=0,this.recognizer=new n.default,this.reset()}function j(e,t){var n,i=!!this.activeTransition,o=i?this.activeTransition.state:this.state,a=e.applyToState(o,this.recognizer,this.getHandler,t,this.getSerializer),s=p(o.queryParams,a.queryParams)
return q(a.handlerInfos,o.handlerInfos)?s&&(n=this.queryParamsTransition(s,i,o,a))?(n.queryParamsOnly=!0,n):this.activeTransition||new b(this):t?void D(this,a):(n=new b(this,e,a,void 0,this.activeTransition),function(e,t){var n,r
...
c&&(p.queryParams=e._visibleQueryParams||t.queryParams,i=l.recognizer.generate(h,p),o=e.isCausedByInitialTransition,s="replace"===c&&!e.isCausedByAbortingTransition,u=e.queryParamsOnly&&"replace"===c,o||s||u?l.replaceURL(i):l.updateURL(i))}}function F(e,t,n){var r,o,a=t[0]||"/",s=t[t.length-1],u={}
return s&&s.hasOwnProperty("queryParams")&&(u=P.call(t).queryParams),0===t.length?(c(e,"Updating query params"),r=e.state.handlerInfos,o=new S({name:r[r.length-1].name,contexts:[],queryParams:u})):"/"===a.charAt(0)?(c(e,"Attempting URL transition to "+a),o=new M({url:a})):(c(e,"Attempting transition to "+a),o=new S({name:t[0],contexts:i.call(t,1),queryParams:u})),e.transitionByIntent(o,n)}function q(e,t){var n,r
if(e.length!==t.length)return!1
...
return c}R.prototype={map:function(e){this.recognizer.delegate=this.delegate,this.recognizer.map(e,function(e,t){var n,r,i
...
return t&&"replace"===t.urlMethod&&o.method(t.urlMethod),o},replaceWith:function(){return F(this,arguments).method("replace")},generate:function(e){var t,n,r=s(i.call(arguments,1)),o=r[0],u=r[1],c=new S({name:e,contexts:o}).applyToState(this.state,this.recognizer,this.getHandler,null,this.getSerializer),l={}
for(t=0,n=c.handlerInfos.length;t<n;++t)a(l,c.handlerInfos[t].serialize())
return l.queryParams=u,this.recognizer.generate(e,l)},applyIntent:function(e,t){var n=new S({name:e,contexts:t}),r=this.activeTransition&&this.activeTransition.state||this.state
...
var h=q(new S({name:u,contexts:t}).applyToHandlers(f,c,this.getHandler,u,!0,!0,this.getSerializer).handlerInfos,f.handlerInfos)
if(!n||!h)return h
var d={}
a(d,n)
var m=o.queryParams
...
h(this,this.currentHandlerInfos,!1,e)},log:null},e.Transition=b,e.default=R}),e("rsvp",["exports","ember-babel","node-module"],function(e,t,n){"use strict"
var r,i
...
t.constructor===e.constructor&&n===P&&e.constructor.resolve===f?function(e,t){t._state===d?C(e,t._result):t._state===m?(t._onError=null,k(e,t._result)):S(t,void 0,function(n){t===n?C(e,n):O(e,n)},function(t){return k(e,t)})}(e,t):n===y?(r=y.error,y.error=null,k(e,r)):"function"==typeof n?function(e,t,n){s.async(function(e){var r=!1,i=function(e,t,n,r){try{e.call(t,n,r)}catch(e){return e}}(n,t,function(n){r||(r=!0,t!==n?O(e,n):C(e,n))},function(t){r||(r=!0,k(e,t))},e._label)
!r&&i&&(r=!0,k(e,i))},e)}(e,t,n):C(e,t)}function O(e,t){var n,r
e===t?C(e,t):(r=typeof(n=t),null===n||"object"!==r&&"function"!==r?C(e,t):E(e,t,v(t)))}function T(e){e._onError&&e._onError(e._result),A(e)}function C(e,t){e._state===p&&(e._result=t,e._state=d,0===e._subscribers.length?s.instrument&&l("fulfilled",e):s.async(A,e))}function k(e,t){e._state===p&&(e._state=m,e._result=t,s.async(T,e))}function S(e,t,n,r){var i=e._subscribers,o=i.length
...
a=o?x(n)(r):r,t._state!==p||(a===t?k(t,new TypeError("A promises callback cannot return that same promise.")):a===b?(i=a.error,a.error=null,k(t,i)):o?O(t,a):e===d?C(t,a):e===m&&k(t,a))}function P(e,t,n){var r,i=this._state
if(i===d&&!e||i===m&&!t)return s.instrument&&l("chained",this,this),this
this._onError=null
var o=new this.constructor(h,n),a=this._result
return s.instrument&&l("chained",this,o),i===p?S(this,o,e,t):(r=i===d?e:t,s.async(function(){return M(i,o,r,a)})),o}var R=function(){function e(e,t,n,r){this._instanceConstructor=e,this.promise=new e(h,r),this._abortOnReject=n,this.isUsingOwnPromise=e===L,this._init.apply(this,arguments)}return e.prototype._init=function(e,t){var n=t.length||0
...
i._state===p&&(this._abortOnReject&&e===m?k(i,n):(this._setResultAt(e,t,n,r),this._checkFullfillment()))},e.prototype._setResultAt=function(e,t,n){this._remaining--,this._result[t]=n},e.prototype._willSettleAt=function(e,t,n){var r=this
S(e,void 0,function(e){return r._settledAt(d,t,e,n)},function(e){return r._settledAt(m,t,e,n)})},e}()
function j(e,t,n){this._remaining--,this._result[t]=e===d?{state:"fulfilled",value:n}:{state:"rejected",reason:n}}var N="rsvp_"+Date.now()+"-",D=0
...
function I(){this.value=void 0}L.cast=f,L.all=function(e,t){return Array.isArray(e)?new R(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},L.race=function(e,t){var n,r=new this(h,t)
if(!Array.isArray(e))return k(r,new TypeError("Promise.race must be called with an array")),r
for(n=0;r._state===p&&n<e.length;n++)S(this.resolve(e[n]),void 0,function(e){return O(r,e)},function(e){return k(r,e)})
return r},L.resolve=f,L.reject=function(e,t){var n=new this(h,t)
return k(n,e),n},L.prototype._guidKey=N,L.prototype.then=P
var F=new I,q=new I
function z(e,t,n){try{e.apply(t,n)}catch(e){return F.value=e,F}}function U(e,t){return{then:function(n,r){return e.call(t,n,r)}}}function B(e,n){var r=function(){var t,r,i,o=arguments.length,a=new Array(o+1),s=!1
for(t=0;t<o;++t){if(r=arguments[t],!s){if((s=H(r))===q)return k(i=new L(h),q.value),i
s&&!0!==s&&(r=U(s,r))}a[t]=r}var u=new L(h)
return a[o]=function(e,t){e?k(u,e):void 0===n?O(u,t):!0===n?O(u,function(e){var t,n=e.length,r=new Array(n-1)
...
return i===F&&k(e,i.value),e})}(u,a,e,this):function(e,t,n,r){var i=z(n,r,t)
i===F&&k(e,i.value)
return e}(u,a,e,this)}
return(0,t.defaults)(r,e),r}function H(e){return!(!e||"object"!=typeof e)&&(e.constructor===L||function(e){try{return e.then}catch(e){return F.value=e,F}}(e))}function V(e,t){return L.all(e,t)}var W=function(e){function n(n,r,i){return(0,t.possibleConstructorReturn)(this,e.call(this,n,r,!1,i))}return(0,t.inherits)(n,e),n}(R)
function Y(e,t){return Array.isArray(e)?new W(L,e,t).promise:L.reject(new TypeError("Promise.allSettled must be called with an array"),t)}function G(e,t){return L.race(e,t)}W.prototype._setResultAt=j
...
this._remaining=o
var a=void 0
for(t=0;n._state===p&&t<o;t++)a=r[t],this._eachEntry(a.entry,a.position)},n}(R)
function $(e,t){return null===e||"object"!=typeof e?L.reject(new TypeError("Promise.hash must be called with an object"),t):new K(L,e,t).promise}var X=function(e){function n(n,r,i){return(0,t.possibleConstructorReturn)(this,e.call(this,n,r,!1,i))}return(0,t.inherits)(n,e),n}(K)
...
ue=0}var be,_e,we,xe,Ee,Oe,Te=void 0
if(de?(Ee=process.nextTick,Oe=process.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/),Array.isArray(Oe)&&"0"===Oe[1]&&"10"===Oe[2]&&(Ee=setImmediate),Te=function(){return Ee(ve)}):pe?(_e=0,we=new pe(ve),xe=document.createTextNode(""),we.observe(xe,{characterData:!0}),Te=function(){return xe.data=_e=++_e%2}):me?((be=new MessageChannel).port1.onmessage=ve,Te=function(){return be.port2.postMessage(0)}):Te=void 0===fe&&"function"==typeof n.require?function(){var e
...
var Ce=re,ke=function(e,t){return s.async(e,t)}
function Se(){s.on.apply(s,arguments)}function Ae(){s.off.apply(s,arguments)}if("undefined"!=typeof window&&"object"==typeof window.__PROMISE_INSTRUMENTATION__)for(var Me in i=window.__PROMISE_INSTRUMENTATION__,u("instrument",!0),i)i.hasOwnProperty(Me)&&Se(Me,i[Me])
var Pe=((r={asap:le,cast:Ce,Promise:L,EventTarget:a,all:V,allSettled:Y,race:G,hash:$,hashSettled:J,rethrow:Z,defer:ee,denodeify:B,configure:u,on:Se,off:Ae,resolve:re,reject:ie,map:ne}).async=ke,r.filter=se,r)
e.asap=le,e.cast=Ce,e.Promise=L,e.EventTarget=a,e.all=V,e.allSettled=Y,e.race=G,e.hash=$,e.hashSettled=J,e.rethrow=Z,e.defer=ee,e.denodeify=B,e.configure=u,e.on=Se,e.off=Ae,e.resolve=re,e.reject=ie,e.map=ne,e.async=ke,e.filter=se,e.default=Pe}),t("ember")}(),function(e){var t,n
...
return r},T=function(e){if(!(i=e.length))return[]
for(var t=-1,n=O(e,C),r=new Array(n);++t<n;)for(var i,o=-1,a=r[t]=new Array(i);++o<i;)a[o]=e[o][t]
return r}
function C(e){return e.length}e.bisect=i,e.bisectRight=i,e.bisectLeft=o,e.ascending=t,e.bisector=n,e.cross=function(e,t,n){var r,i,o,s,u=e.length,c=t.length,l=new Array(u*c)
...
return r&&o.reverse(),o},e.tickIncrement=_,e.tickStep=w,e.transpose=T,e.variance=u
e.zip=function(){return T(arguments)},Object.defineProperty(e,"__esModule",{value:!0})},"object"==typeof exports&&"undefined"!=typeof module?n(exports):"function"==typeof e&&e.amd?e(["exports"],n):n(t.d3=t.d3||{})}(function(){function e(){var e=Array.prototype.slice.call(arguments)
...
function w(t){var u=null==p?f.ticks?f.ticks.apply(f,h):f.domain():p,c=null==d?f.tickFormat?f.tickFormat.apply(f,h):n:d,w=Math.max(m,0)+y,x=f.range(),E=+x[0]+.5,O=+x[x.length-1]+.5,T=(f.bandwidth?function(e){var t=Math.max(0,e.bandwidth()-1)/2
return e.round()&&(t=Math.round(t)),function(n){return+e(n)+t}}:function(e){return function(t){return+e(t)}})(f.copy()),C=t.selection?t.selection():t,k=C.selectAll(".domain").data([null]),S=C.selectAll(".tick").data(u,f).order(),A=S.exit(),M=S.enter().append("g").attr("class","tick"),P=S.select("line"),R=S.select("text")
k=k.merge(k.enter().insert("path",".tick").attr("class","domain").attr("stroke","#000")),S=S.merge(M),P=P.merge(M.append("line").attr("stroke","#000").attr(b+"2",v*m)),R=R.merge(M.append("text").attr("fill","#000").attr(b,v*w).attr("dy",e===r?"0em":e===o?"0.71em":"0.32em")),t!==C&&(k=k.transition(t),S=S.transition(t),P=P.transition(t),R=R.transition(t),A=A.transition(t).attr("opacity",s).attr("transform",function(e){return isFinite(e=T(e))?_(e):this.getAttribute("transform")}),M.attr("opacity",s).attr("transform",function(e){var t=this.parentNode.__axis
return _(t&&isFinite(t=t(e))?t:T(e))})),A.remove(),k.attr("d",e===a||e==i?"M"+v*g+","+E+"H0.5V"+O+"H"+v*g:"M"+E+","+v*g+"V0.5H"+O+"V"+v*g),S.attr("opacity",1).attr("transform",function(e){return _(T(e))}),P.attr(b+"2",v*m),R.attr(b,v*w).text(c),C.filter(l).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",e===i?"start":e===a?"end":"middle"),C.each(function(){this.__axis=T})}return w.scale=function(e){return arguments.length?(f=e,w):f},w.ticks=function(){return h=t.call(arguments),w},w.tickArguments=function(e){return arguments.length?(h=null==e?[]:t.call(e),w):h.slice()},w.tickValues=function(e){return arguments.length?(p=null==e?null:t.call(e),w):p&&p.slice()},w.tickFormat=function(e){return arguments.length?(d=e,w):d},w.tickSize=function(e){return arguments.length?(m=g=+e,w):m},w.tickSizeInner=function(e){return arguments.length?(m=+e,w):m},w.tickSizeOuter=function(e){return arguments.length?(g=+e,w):g},w.tickPadding=function(e){return arguments.length?(y=+e,w):y},w}e.axisTop=function(e){return f(r,e)},e.axisRight=function(e){return f(i,e)},e.axisBottom=function(e){return f(o,e)},e.axisLeft=function(e){return f(a,e)},Object.defineProperty(e,"__esModule",{value:!0})},"object"==typeof exports&&"undefined"!=typeof module?n(exports):"function"==typeof e&&e.amd?e(["exports"],n):n(t.d3=t.d3||{})}(function(){function e(){var e=Array.prototype.slice.call(arguments)
...
return[[0,0],[e.width.baseVal.value,e.height.baseVal.value]]}function T(e){for(;!e.__brush;)if(!(e=e.parentNode))return
return e.__brush}function C(e){return e[0][0]===e[1][0]||e[0][1]===e[1][1]}function k(e){var g,k=O,S=E,A=t.dispatch(P,"start","brush","end"),M=6
function P(t){var n=t.property("__brush",L).selectAll(".overlay").data([x("overlay")])
n.enter().append("rect").attr("class","overlay").attr("pointer-events","all").attr("cursor",y.overlay).merge(n).each(function(){var e=T(this).extent
...
r.exit().remove(),r.enter().append("rect").attr("class",function(e){return"handle handle--"+e.type}).attr("cursor",function(e){return y[e.type]}),t.each(R).attr("fill","none").attr("pointer-events","all").style("-webkit-tap-highlight-color","rgba(0,0,0,0)").on("mousedown.brush touchstart.brush",D)}function R(){var e=i.select(this),t=T(this).selection
t?(e.selectAll(".selection").style("display",null).attr("x",t[0][0]).attr("y",t[0][1]).attr("width",t[1][0]-t[0][0]).attr("height",t[1][1]-t[0][1]),e.selectAll(".handle").style("display",null).attr("x",function(e){return"e"===e.type[e.type.length-1]?t[1][0]-M/2:t[0][0]-M/2}).attr("y",function(e){return"s"===e.type[0]?t[1][1]-M/2:t[0][1]-M/2}).attr("width",function(e){return"n"===e.type||"s"===e.type?t[1][0]-t[0][0]+M:M}).attr("height",function(e){return"e"===e.type||"w"===e.type?t[1][1]-t[0][1]+M:M})):e.selectAll(".selection,.handle").style("display","none").attr("x",null).attr("y",null).attr("width",null).attr("height",null)}function j(e,t){return e.__brush.emitter||new N(e,t)}function N(e,t){this.that=e,this.args=t,this.state=e.__brush,this.active=0}function D(){if(i.event.touches){if(i.event.changedTouches.length<i.event.touches.length)return c()}else if(g)return
if(S.apply(this,arguments)){var t,r,a,s,x,E,O,k,A,M,P,N,D,L=this,I=i.event.target.__data__.type,F="selection"===(i.event.metaKey?I="overlay":I)?l:i.event.altKey?p:h,q=e===m?null:_[I],z=e===d?null:w[I],U=T(L),B=U.extent,H=U.selection,V=B[0][0],W=B[0][1],Y=B[1][0],G=B[1][1],Q=q&&z&&i.event.shiftKey,K=i.mouse(L),$=K,X=j(L,arguments).beforestart()
"overlay"===I?U.selection=H=[[t=e===m?V:K[0],a=e===d?W:K[1]],[x=e===m?Y:t,O=e===d?G:a]]:(t=H[0][0],a=H[0][1],x=H[1][0],O=H[1][1]),r=t,s=a,E=x,k=O
...
else{var ee=i.select(i.event.view).on("keydown.brush",function(){switch(i.event.keyCode){case 16:Q=q&&z
break
case 18:F===h&&(q&&(x=E-A*q,t=r+A*q),z&&(O=k-M*z,a=s+M*z),F=p,ne())
break
case 32:F!==h&&F!==p||(q<0?x=E-A:q>0&&(t=r-A),z<0?O=k-M:z>0&&(a=s-M),F=f,Z.attr("cursor",y.selection),ne())
break
default:return}c()},!0).on("keyup.brush",function(){switch(i.event.keyCode){case 16:Q&&(N=D=Q=!1,ne())
break
case 18:F===p&&(q<0?x=E:q>0&&(t=r),z<0?O=k:z>0&&(a=s),F=h,ne())
break
case 32:F===f&&(i.event.altKey?(q&&(x=E-A*q,t=r+A*q),z&&(O=k-M*z,a=s+M*z),F=p):(q<0?x=E:q>0&&(t=r),z<0?O=k:z>0&&(a=s),F=h),Z.attr("cursor",y[I]),ne())
break
default:return}c()},!0).on("mousemove.brush",te,!0).on("mouseup.brush",re,!0)
n.dragDisable(i.event.view)}u(),o.interrupt(L),R.call(L),X.start()}function te(){var e=i.mouse(L)
!Q||N||D||(Math.abs(e[0]-$[0])>Math.abs(e[1]-$[1])?D=!0:N=!0),$=e,P=!0,c(),ne()}function ne(){var e
switch(A=$[0]-K[0],M=$[1]-K[1],F){case f:case l:q&&(A=Math.max(V-t,Math.min(Y-x,A)),r=t+A,E=x+A),z&&(M=Math.max(W-a,Math.min(G-O,M)),s=a+M,k=O+M)
break
case h:q<0?(A=Math.max(V-t,Math.min(Y-t,A)),r=t+A,E=x):q>0&&(A=Math.max(V-x,Math.min(Y-x,A)),r=t,E=x+A),z<0?(M=Math.max(W-a,Math.min(G-a,M)),s=a+M,k=O):z>0&&(M=Math.max(W-O,Math.min(G-O,M)),s=a,k=O+M)
break
case p:q&&(r=Math.max(V,Math.min(Y,t-A*q)),E=Math.max(V,Math.min(Y,x+A*q))),z&&(s=Math.max(W,Math.min(G,a-M*z)),k=Math.max(W,Math.min(G,O+M*z)))}E<r&&(q*=-1,e=t,t=x,x=e,e=r,r=E,E=e,I in v&&Z.attr("cursor",y[I=v[I]])),k<s&&(z*=-1,e=a,a=O,O=e,e=s,s=k,k=e,I in b&&Z.attr("cursor",y[I=b[I]])),U.selection&&(H=U.selection),N&&(r=H[0][0],E=H[1][0]),D&&(s=H[0][1],k=H[1][1]),H[0][0]===r&&H[0][1]===s&&H[1][0]===E&&H[1][1]===k||(U.selection=[[r,s],[E,k]],R.call(L),X.brush())}function re(){if(u(),i.event.touches){if(i.event.touches.length)return
...
J.attr("pointer-events","all"),Z.attr("cursor",y.overlay),U.selection&&(H=U.selection),C(H)&&(U.selection=null,R.call(L)),X.end()}}function L(){var t=this.__brush||{selection:null}
return t.extent=k.apply(this,arguments),t.dim=e,t}return P.move=function(t,n){t.selection?t.on("start.brush",function(){j(this,arguments).beforestart().start()}).on("interrupt.brush end.brush",function(){j(this,arguments).end()}).tween("brush",function(){var t=this,i=t.__brush,o=j(t,arguments),a=i.selection,s=e.input("function"==typeof n?n.apply(this,arguments):n,i.extent),u=r.interpolate(a,s)
function c(e){i.selection=1===e&&C(s)?null:u(e),R.call(t),o.brush()}return a&&s?c:c(1)}):t.each(function(){var t=arguments,r=this.__brush,i=e.input("function"==typeof n?n.apply(this,t):n,r.extent),a=j(this,t).beforestart()
o.interrupt(this),r.selection=null==i||C(i)?null:i,R.call(this),a.start().brush().end()})},N.prototype={beforestart:function(){return 1==++this.active&&(this.state.emitter=this,this.starting=!0),this},start:function(){return this.starting&&(this.starting=!1,this.emit("start")),this},brush:function(){return this.emit("brush"),this},end:function(){return 0==--this.active&&(delete this.state.emitter,this.emit("end")),this},emit:function(t){i.customEvent(new s(P,t,e.output(this.state.selection)),A.apply,A,[t,this.that,this.args])}},P.extent=function(e){return arguments.length?(k="function"==typeof e?e:a([[+e[0][0],+e[0][1]],[+e[1][0],+e[1][1]]]),P):k},P.filter=function(e){return arguments.length?(S="function"==typeof e?e:a(!!e),P):S},P.handleSize=function(e){return arguments.length?(M=+e,P):M},P.on=function(){var e=A.on.apply(A,arguments)
return e===A?P:e},P}e.brush=function(){return k(g)},e.brushX=function(){return k(d)},e.brushY=function(){return k(m)},e.brushSelection=function(e){var t=e.__brush
...
m.push(c),y.push(t.range(d)),a+=c}for(n&&g.sort(function(e,t){return n(m[e],m[t])}),r&&y.forEach(function(e,t){e.sort(function(e,n){return r(o[t][e],o[t][n])})}),f=(a=u(0,s-e*d)/a)?e:s/d,c=0,h=-1;++h<d;){for(l=c,p=-1;++p<d;){var w=g[h],x=y[w][p],E=o[w][x],O=c,T=c+=E*a
_[x*d+w]={index:w,subindex:x,startAngle:O,endAngle:T,value:E}}b[w]={index:w,startAngle:l,endAngle:c,value:m[w]},c+=f}for(h=-1;++h<d;)for(p=h-1;++p<d;){var C=_[p*d+h],k=_[h*d+p];(C.value||k.value)&&v.push(C.value<k.value?{source:k,target:C}:{source:C,target:k})}return i?v.sort(i):v}return o.padAngle=function(t){return arguments.length?(e=u(0,t),o):e},o.sortGroups=function(e){return arguments.length?(n=e,o):n},o.sortSubgroups=function(e){return arguments.length?(r=e,o):r},o.sortChords=function(e){return arguments.length?(null==e?i=null:(t=e,i=function(e,n){return t(e.source.value+e.target.value,n.source.value+n.target.value)})._=e,o):i&&i._
...
return new w(T(e>=240?e-240:e+120,i,r),T(e,i,r),T(e<120?e+240:e-120,i,r),this.opacity)},displayable:function(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1}}))
var C=Math.PI/180,k=180/Math.PI,S=.95047,A=1,M=1.08883,P=4/29,R=6/29,j=3*R*R,N=R*R*R
function D(e){if(e instanceof I)return new I(e.l,e.a,e.b,e.opacity)
if(e instanceof H){var t=e.h*C
return new I(e.l,Math.cos(t)*e.c,Math.sin(t)*e.c,e.opacity)}e instanceof w||(e=b(e))
var n=U(e.r),r=U(e.g),i=U(e.b),o=F((.4124564*n+.3575761*r+.1804375*i)/S),a=F((.2126729*n+.7151522*r+.072175*i)/A)
return new I(116*a-16,500*(o-a),200*(a-F((.0193339*n+.119192*r+.9503041*i)/M)),e.opacity)}function L(e,t,n,r){return 1===arguments.length?D(e):new I(e,t,n,null==r?1:r)}function I(e,t,n,r){this.l=+e,this.a=+t,this.b=+n,this.opacity=+r}function F(e){return e>N?Math.pow(e,1/3):e/j+P}function q(e){return e>R?e*e*e:j*(e-P)}function z(e){return 255*(e<=.0031308?12.92*e:1.055*Math.pow(e,1/2.4)-.055)}function U(e){return(e/=255)<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function B(e,t,n,r){return 1===arguments.length?function(e){if(e instanceof H)return new H(e.h,e.c,e.l,e.opacity)
e instanceof I||(e=D(e))
var t=Math.atan2(e.b,e.a)*k
...
var t=e.r/255,n=e.g/255,r=e.b/255,i=(X*r+K*t-$*n)/(X+K-$),o=r-i,a=(Q*(n-i)-Y*o)/G,s=Math.sqrt(a*a+o*o)/(Q*i*(1-i)),u=s?Math.atan2(a,o)*k-120:NaN
return new Z(u<0?u+360:u,s,i,e.opacity)}(e):new Z(e,t,n,null==r?1:r)}function Z(e,t,n,r){this.h=+e,this.s=+t,this.l=+n,this.opacity=+r}t(Z,J,n(r,{brighter:function(e){return e=null==e?1/.7:Math.pow(1/.7,e),new Z(this.h,this.s,this.l*e,this.opacity)},darker:function(e){return e=null==e?.7:Math.pow(.7,e),new Z(this.h,this.s,this.l*e,this.opacity)},rgb:function(){var e=isNaN(this.h)?0:(this.h+120)*C,t=+this.l,n=isNaN(this.s)?0:this.s*t*(1-t),r=Math.cos(e),i=Math.sin(e)
return new w(255*(t+n*(V*r+W*i)),255*(t+n*(Y*r+G*i)),255*(t+n*(Q*r)),this.opacity)}})),e.color=g,e.rgb=_,e.hsl=E,e.lab=L,e.hcl=B,e.cubehelix=J,Object.defineProperty(e,"__esModule",{value:!0})},"object"==typeof exports&&"undefined"!=typeof module?n(exports):"function"==typeof e&&e.amd?e(["exports"],n):n(t.d3=t.d3||{})}(function(){function e(){var e=Array.prototype.slice.call(arguments)
...
function O(e){e.on("mousedown.drag",T).filter(b).on("touchstart.drag",S).on("touchmove.drag",A).on("touchend.drag touchcancel.drag",M).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function T(){if(!m&&g.apply(this,arguments)){var t=P("mouse",y.apply(this,arguments),n.mouse,this,arguments)
t&&(n.select(n.event.view).on("mousemove.drag",C,!0).on("mouseup.drag",k,!0),o(n.event.view),r(),d=!1,e=n.event.clientX,p=n.event.clientY,t("start"))}}function C(){if(i(),!d){var t=n.event.clientX-e,r=n.event.clientY-p
d=t*t+r*r>E}_.mouse("drag")}function k(){n.select(n.event.view).on("mousemove.drag mouseup.drag",null),a(n.event.view,d),i(),_.mouse("end")}function S(){if(g.apply(this,arguments)){var e,t,i=n.event.changedTouches,o=y.apply(this,arguments),a=i.length
for(e=0;e<a;++e)(t=P(i[e].identifier,o,n.touch,this,arguments))&&(r(),t("start"))}}function A(){var e,t,r=n.event.changedTouches,o=r.length
...
function w(e){return(e=+e)<f?_*e*e:e<p?_*(e-=h)*e+d:e<g?_*(e-=m)*e+y:_*(e-=v)*e+b}var x=function e(t){function n(e){return e*e*((t+1)*e-t)}return t=+t,n.overshoot=e,n}(1.70158),E=function e(t){function n(e){return--e*e*((t+1)*e+t)+1}return t=+t,n.overshoot=e,n}(1.70158),O=function e(t){function n(e){return((e*=2)<1?e*e*((t+1)*e-t):(e-=2)*e*((t+1)*e+t)+2)/2}return t=+t,n.overshoot=e,n}(1.70158),T=2*Math.PI,C=function e(t,n){var r=Math.asin(1/(t=Math.max(1,t)))*(n/=T)
function i(e){return t*Math.pow(2,10*--e)*Math.sin((r-e)/n)}return i.amplitude=function(t){return e(t,n*T)},i.period=function(n){return e(t,n)},i}(1,.3),k=function e(t,n){var r=Math.asin(1/(t=Math.max(1,t)))*(n/=T)
function i(e){return 1-t*Math.pow(2,-10*(e=+e))*Math.sin((e+r)/n)}return i.amplitude=function(t){return e(t,n*T)},i.period=function(n){return e(t,n)},i}(1,.3),S=function e(t,n){var r=Math.asin(1/(t=Math.max(1,t)))*(n/=T)
function i(e){return((e=2*e-1)<0?t*Math.pow(2,10*e)*Math.sin((r-e)/n):2-t*Math.pow(2,-10*e)*Math.sin((r+e)/n))/2}return i.amplitude=function(t){return e(t,n*T)},i.period=function(n){return e(t,n)},i}(1,.3)
...
e.easeBackIn=x,e.easeBackOut=E,e.easeBackInOut=O,e.easeElastic=k,e.easeElasticIn=C,e.easeElasticOut=k,e.easeElasticInOut=S,Object.defineProperty(e,"__esModule",{value:!0})},"object"==typeof exports&&"undefined"!=typeof module?n(exports):"function"==typeof e&&e.amd?e(["exports"],n):n(t.d3=t.d3||{})}(function(){function e(){var e=Array.prototype.slice.call(arguments)
...
break}}g&&!d&&(e=a(e,1/0))
var O=l.length+e.length+p.length,T=O<m?new Array(m-O+1).join(n):""
switch(g&&d&&(e=a(T+e,T.length?m-p.length:1/0),T=""),r){case"<":e=l+e+p+T
break
case"=":e=l+T+e+p
break
case"^":e=T.slice(0,O=T.length>>1)+l+e+p+T.slice(O)
break
default:e=T+l+e+p}return h(e)}return y=null==y?v?6:12:/[gprs]/.test(v)?Math.max(1,Math.min(21,y)):Math.max(0,Math.min(20,y)),E.toString=function(){return e+""},E}return{format:d,formatPrefix:function(e,t){var n=d(((e=s(e)).type="f",e)),i=3*Math.max(-8,Math.min(8,Math.floor(r(t)/3))),o=Math.pow(10,-i),a=f[8+i/3]
...
function T(e){return e>1?0:e<-1?s:Math.acos(e)}function C(e){return e>1?u:e<-1?-u:Math.asin(e)}function k(e){return(e=w(e/2))*e}function S(){}function A(e,t){e&&P.hasOwnProperty(e.type)&&P[e.type](e,t)}var M={Feature:function(e,t){A(e.geometry,t)},FeatureCollection:function(e,t){for(var n=e.features,r=-1,i=n.length;++r<i;)A(n[r].geometry,t)}},P={Sphere:function(e,t){t.sphere()},Point:function(e,t){e=e.coordinates,t.point(e[0],e[1],e[2])},MultiPoint:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)e=n[r],t.point(e[0],e[1],e[2])},LineString:function(e,t){R(e.coordinates,t,0)},MultiLineString:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)R(n[r],t,0)},Polygon:function(e,t){j(e.coordinates,t)},MultiPolygon:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)j(n[r],t)},GeometryCollection:function(e,t){for(var n=e.geometries,r=-1,i=n.length;++r<i;)A(n[r],t)}}
function R(e,t,n){var r,i=-1,o=e.length-n
for(t.lineStart();++i<o;)r=e[i],t.point(r[0],r[1],r[2])
t.lineEnd()}function j(e,t){var n=-1,r=e.length
for(t.polygonStart();++n<r;)R(e[n],t,1)
t.polygonEnd()}var N,D,L,I,F,q=function(e,t){e&&M.hasOwnProperty(e.type)?M[e.type](e,t):A(e,t)},z=n(),U=n(),B={point:S,lineStart:S,lineEnd:S,polygonStart:function(){z.reset(),B.lineStart=H,B.lineEnd=V},polygonEnd:function(){var e=+z
U.add(e<0?l+e:e),this.lineStart=this.lineEnd=this.point=S},sphere:function(){U.add(l)}}
function H(){B.point=W}function V(){Y(N,D)}function W(e,t){B.point=Y,N=e,D=t,L=e*=h,I=g(t=(t*=h)/2+c),F=w(t)}function Y(e,t){t=(t*=h)/2+c
var n=(e*=h)-L,r=n>=0?1:-1,i=r*n,o=g(t),a=w(t),s=F*a,u=I*o+s*g(i),l=s*r*w(i)
z.add(m(l,u)),L=e,I=o,F=a}var G,Q,K,$,X,J,Z,ee
function te(e){return[m(e[1],e[0]),C(e[2])]}function ne(e){var t=e[0],n=e[1],r=g(n)
...
e[0]/=t,e[1]/=t,e[2]/=t}var ue,ce,le=n(),fe={point:he,lineStart:de,lineEnd:me,polygonStart:function(){fe.point=ge,fe.lineStart=ye,fe.lineEnd=ve,le.reset(),B.polygonStart()},polygonEnd:function(){B.polygonEnd(),fe.point=he,fe.lineStart=de,fe.lineEnd=me,z<0?(G=-(K=180),Q=-($=90)):le>a?$=90:le<-a&&(Q=-90),ce[0]=G,ce[1]=K}}
function he(e,t){ue.push(ce=[G=e,K=e]),t<Q&&(Q=t),t>$&&($=t)}function pe(e,t){var n=ne([e*h,t*h])
if(ee){var r=ie(ee,n),i=ie([r[1],-r[0],0],r)
se(i),i=te(i)
var o,a=e-X,s=a>0?1:-1,u=i[0]*f*s,c=p(a)>180
c^(s*X<u&&u<s*e)?(o=i[1]*f)>$&&($=o):c^(s*X<(u=(u+360)%360-180)&&u<s*e)?(o=-i[1]*f)<Q&&(Q=o):(t<Q&&(Q=t),t>$&&($=t)),c?e<X?be(G,e)>be(G,K)&&(K=e):be(e,K)>be(G,K)&&(G=e):K>=G?(e<G&&(G=e),e>K&&(K=e)):e>X?be(G,e)>be(G,K)&&(K=e):be(e,K)>be(G,K)&&(G=e)}else ue.push(ce=[G=e,K=e])
t<Q&&(Q=t),t>$&&($=t),ee=n,X=e}function de(){fe.point=pe}function me(){ce[0]=G,ce[1]=K,fe.point=he,ee=null}function ge(e,t){if(ee){var n=e-X
le.add(p(n)>180?n+(n>0?360:-360):n)}else J=e,Z=t
B.point(e,t),pe(e,t)}function ye(){B.lineStart()}function ve(){ge(J,Z),B.lineEnd(),p(le)>a&&(G=-(K=180)),ce[0]=G,ce[1]=K,ee=null}function be(e,t){return(t-=e)<0?t+360:t}function _e(e,t){return e[0]-t[0]}function we(e,t){return e[0]<=e[1]?e[0]<=t&&t<=e[1]:t<e[0]||e[1]<t}var xe,Ee,Oe,Te,Ce,ke,Se,Ae,Me,Pe,Re,je,Ne,De,Le,Ie,Fe={sphere:S,point:qe,lineStart:Ue,lineEnd:Ve,polygonStart:function(){Fe.lineStart=We,Fe.lineEnd=Ye},polygonEnd:function(){Fe.lineStart=Ue,Fe.lineEnd=Ve}}
function qe(e,t){e*=h
var n=g(t*=h)
ze(n*g(e),n*w(e),w(t))}function ze(e,t,n){Oe+=(e-Oe)/++xe,Te+=(t-Te)/xe,Ce+=(n-Ce)/xe}function Ue(){Fe.point=Be}function Be(e,t){e*=h
var n=g(t*=h)
De=n*g(e),Le=n*w(e),Ie=w(t),Fe.point=He,ze(De,Le,Ie)}function He(e,t){e*=h
var n=g(t*=h),r=n*g(e),i=n*w(e),o=w(t),a=m(E((a=Le*o-Ie*i)*a+(a=Ie*r-De*o)*a+(a=De*i-Le*r)*a),De*r+Le*i+Ie*o)
Ee+=a,ke+=a*(De+(De=r)),Se+=a*(Le+(Le=i)),Ae+=a*(Ie+(Ie=o)),ze(De,Le,Ie)}function Ve(){Fe.point=qe}function We(){Fe.point=Ge}function Ye(){Qe(je,Ne),Fe.point=qe}function Ge(e,t){je=e,Ne=t,e*=h,t*=h,Fe.point=Qe
var n=g(t)
De=n*g(e),Le=n*w(e),Ie=w(t),ze(De,Le,Ie)}function Qe(e,t){e*=h
var n=g(t*=h),r=n*g(e),i=n*w(e),o=w(t),a=Le*o-Ie*i,s=Ie*r-De*o,u=De*i-Le*r,c=E(a*a+s*s+u*u),l=C(c),f=c&&-l/c
Me+=f*a,Pe+=f*s,Re+=f*u,Ee+=l,ke+=l*(De+(De=r)),Se+=l*(Le+(Le=i)),Ae+=l*(Ie+(Ie=o)),ze(De,Le,Ie)}var Ke=function(e){return function(){return e}},$e=function(e,t){function n(n,r){return n=e(n,r),t(n[0],n[1])}return e.invert&&t.invert&&(n.invert=function(n,r){return(n=t.invert(n,r))&&e.invert(n[0],n[1])}),n}
...
return[m(u*i-l*o,s*n-c*r),C(l*i+u*o)]}return a.invert=function(e,t){var a=g(t),s=g(e)*a,u=w(e)*a,c=w(t),l=c*i-u*o
return[m(u*i+c*o,s*n+l*r),C(l*n-s*r)]},a}Xe.invert=Xe
...
lt.reset()
for(var f=0,h=e.length;f<h;++f)if(d=(p=e[f]).length)for(var p,d,y=p[d-1],v=y[0],b=y[1]/2+c,_=w(b),x=g(b),E=0;E<d;++E,v=T,_=S,x=A,y=O){var O=p[E],T=O[0],k=O[1]/2+c,S=w(k),A=g(k),M=T-v,P=M>=0?1:-1,R=P*M,j=R>s,N=_*S
if(lt.add(m(N*P*w(R),x*A+N*g(R))),o+=j?M+P*l:M,j^v>=n^T>=n){var D=ie(ne(y),ne(O))
se(D)
var L=ie(i,D)
se(L)
var I=(j^M>=0?-1:1)*C(L[2]);(r>I||r===I&&(D[0]||D[1]))&&(u+=j^M>=0?1:-1)}}return(o<-a||o<a&&lt<-a)^1&u},ht=function(e,n,r,i){return function(o){var a,s,u,c=n(o),l=ot(),f=n(l),h=!1,p={point:d,lineStart:g,lineEnd:y,polygonStart:function(){p.point=v,p.lineStart=b,p.lineEnd=_,s=[],a=[]},polygonEnd:function(){p.point=d,p.lineStart=g,p.lineEnd=y,s=t.merge(s)
var e=ft(a,i)
...
var x,O=e[0],T=n[0],C=e[1],k=n[1]
T<O&&(x=O,O=T,T=x)
var S=T-O,A=p(S-s)<a
if(!A&&k<C&&(x=C,C=k,k=x),A||S<a?A?C+k>0^w[1]<(p(w[0]-O)<a?C:k):C<=w[1]&&w[1]<=k:S>s^(O<=w[0]&&w[0]<=T)){var M=ae(g,(-y+_)/v)
...
yt(u,c,e,n,r,i)?(y||(_.lineStart(),_.point(u[0],u[1])),_.point(c[0],c[1]),s||_.lineEnd(),b=!1):s&&(_.lineStart(),_.point(t,a),b=!1)}m=t,g=a,y=s}return x}}var wt,xt,Et,Ot=n(),Tt={sphere:S,point:S,lineStart:function(){Tt.point=kt,Tt.lineEnd=Ct},lineEnd:S,polygonStart:S,polygonEnd:S}
function Ct(){Tt.point=Tt.lineEnd=S}function kt(e,t){wt=e*=h,xt=w(t*=h),Et=g(t),Tt.point=St}function St(e,t){e*=h
var n=w(t*=h),r=g(t),i=p(e-wt),o=g(i),a=r*w(i),s=Et*n-xt*r*o,u=xt*n+Et*r*o
Ot.add(m(E(a*a+s*s),u)),wt=e,xt=n,Et=r}var At=function(e){return Ot.reset(),q(e,Tt),+Ot},Mt=[null,null],Pt={type:"LineString",coordinates:Mt},Rt=function(e,t){return Mt[0]=e,Mt[1]=t,At(Pt)},jt={Feature:function(e,t){return Dt(e.geometry,t)},FeatureCollection:function(e,t){for(var n=e.features,r=-1,i=n.length;++r<i;)if(Dt(n[r].geometry,t))return!0
...
return!1},Polygon:function(e,t){return Ft(e.coordinates,t)},MultiPolygon:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)if(Ft(n[r],t))return!0
return!1},GeometryCollection:function(e,t){for(var n=e.geometries,r=-1,i=n.length;++r<i;)if(Dt(n[r],t))return!0
return!1}}
function Dt(e,t){return!(!e||!Nt.hasOwnProperty(e.type))&&Nt[e.type](e,t)}function Lt(e,t){return 0===Rt(e,t)}function It(e,t){var n=Rt(e[0],e[1])
return Rt(e[0],t)+Rt(t,e[1])<=n+a}function Ft(e,t){return!!ft(e.map(qt),zt(t))}function qt(e){return(e=e.map(zt)).pop(),e}function zt(e){return[e[0]*h,e[1]*h]}function Ut(e,n,r){var i=t.range(e,n-a,r).concat(n)
...
e>on&&(on=e)
t<rn&&(rn=t)
t>an&&(an=t)},lineStart:S,lineEnd:S,polygonStart:S,polygonEnd:S,result:function(){var e=[[nn,rn],[on,an]]
return on=an=-(rn=nn=1/0),e}}
var un,cn,ln,fn,hn=0,pn=0,dn=0,mn=0,gn=0,yn=0,vn=0,bn=0,_n=0,wn={point:xn,lineStart:En,lineEnd:Cn,polygonStart:function(){wn.lineStart=kn,wn.lineEnd=Sn},polygonEnd:function(){wn.point=xn,wn.lineStart=En,wn.lineEnd=Cn},result:function(){var e=_n?[vn/_n,bn/_n]:yn?[mn/yn,gn/yn]:dn?[hn/dn,pn/dn]:[NaN,NaN]
return hn=pn=dn=mn=gn=yn=vn=bn=_n=0,e}}
function xn(e,t){hn+=e,pn+=t,++dn}function En(){wn.point=On}function On(e,t){wn.point=Tn,xn(ln=e,fn=t)}function Tn(e,t){var n=e-ln,r=t-fn,i=E(n*n+r*r)
mn+=i*(ln+e)/2,gn+=i*(fn+t)/2,yn+=i,xn(ln=e,fn=t)}function Cn(){wn.point=xn}function kn(){wn.point=An}function Sn(){Mn(un,cn)}function An(e,t){wn.point=Mn,xn(un=ln=e,cn=fn=t)}function Mn(e,t){var n=e-ln,r=t-fn,i=E(n*n+r*r)
...
break
default:this._context.moveTo(e+this._radius,t),this._context.arc(e,t,this._radius,0,l)}},result:S}
var Rn,jn,Nn,Dn,Ln,In=n(),Fn={point:S,lineStart:function(){Fn.point=qn},lineEnd:function(){Rn&&zn(jn,Nn),Fn.point=S},polygonStart:function(){Rn=!0},polygonEnd:function(){Rn=null},result:function(){var e=+In
return In.reset(),e}}
function qn(e,t){Fn.point=zn,jn=Dn=e,Nn=Ln=t}function zn(e,t){Dn-=e,Ln-=t,In.add(E(Dn*Dn+Ln*Ln)),Dn=e,Ln=t}function Un(){this._string=[]}function Bn(e){return"m0,"+e+"a"+e+","+e+" 0 1,1 0,"+-2*e+"a"+e+","+e+" 0 1,1 0,"+2*e+"z"}Un.prototype={_radius:4.5,_circle:Bn(4.5),pointRadius:function(e){return(e=+e)!==this._radius&&(this._radius=e,this._circle=null),this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){0===this._line&&this._string.push("Z"),this._point=NaN},point:function(e,t){switch(this._point){case 0:this._string.push("M",e,",",t),this._point=1
break
...
return e.scale(150).translate([0,0]),null!=r&&e.clipExtent(null),q(n,e.stream(sn)),t(sn.result()),null!=r&&e.clipExtent(r),e}function Yn(e,t,n){return Wn(e,function(n){var r=t[1][0]-t[0][0],i=t[1][1]-t[0][1],o=Math.min(r/(n[1][0]-n[0][0]),i/(n[1][1]-n[0][1])),a=+t[0][0]+(r-o*(n[1][0]+n[0][0]))/2,s=+t[0][1]+(i-o*(n[1][1]+n[0][1]))/2
e.scale(150*o).translate([a,s])},n)}function Gn(e,t,n){return Yn(e,[[0,0],t],n)}function Qn(e,t,n){return Wn(e,function(n){var r=+t,i=r/(n[1][0]-n[0][0]),o=(r-i*(n[1][0]+n[0][0]))/2,a=-i*n[0][1]
e.scale(150*i).translate([o,a])},n)}function Kn(e,t,n){return Wn(e,function(n){var r=+t,i=r/(n[1][1]-n[0][1]),o=-i*n[0][0],a=(r-i*(n[1][1]+n[0][1]))/2
...
if(x>4*t&&v--){var O=s+d,T=u+g,k=c+y,S=E(O*O+T*T+k*k),A=C(k/=S),M=p(p(k)-1)<a||p(o-h)<a?(o+h)/2:m(T,O),P=e(M,A),R=P[0],j=P[1],N=R-r,D=j-i,L=w*N-_*D;(L*L/x>t||p((_*N+w*D)/x-.5)>.3||s*d+u*g+c*y<Xn)&&(n(r,i,o,s,u,c,R,j,M,O/=S,T/=S,k,v,b),b.point(R,j),n(R,j,M,O,T,k,l,f,h,d,g,y,v,b))}}return function(t){var r,i,o,a,s,u,c,l,f,h,p,d,m={point:g,lineStart:y,lineEnd:b,polygonStart:function(){t.polygonStart(),m.lineStart=_},polygonEnd:function(){t.polygonEnd(),m.lineStart=y}}
...
function er(e){return tr(function(){return e})()}function tr(e){var t,n,r,i,o,a,s,u,c,l,p=150,d=480,m=250,g=0,y=0,v=0,b=0,_=0,w=null,x=mt,O=null,T=Qt,C=.5,k=Jn(M,C)
function S(e){return[(e=o(e[0]*h,e[1]*h))[0]*p+n,r-e[1]*p]}function A(e){return(e=o.invert((e[0]-n)/p,(r-e[1])/p))&&[e[0]*f,e[1]*f]}function M(e,i){return[(e=t(e,i))[0]*p+n,r-e[1]*p]}function P(){o=$e(i=Je(v,b,_),t)
var e=t(g,y)
return n=d-e[0]*p,r=m+e[1]*p,R()}function R(){return c=l=null,S}return S.stream=function(e){return c&&l===e?c:c=Zn(function(e){return Hn({point:function(t,n){var r=e(t,n)
return this.stream.point(r[0],r[1])}})}(i)(x(k(T(l=e)))))},S.preclip=function(e){return arguments.length?(x=e,w=void 0,R()):x},S.postclip=function(e){return arguments.length?(T=e,O=a=s=u=null,R()):T},S.clipAngle=function(e){return arguments.length?(x=+e?gt(w=e*h):(w=null,mt),R()):w*f},S.clipExtent=function(e){return arguments.length?(T=null==e?(O=a=s=u=null,Qt):_t(O=+e[0][0],a=+e[0][1],s=+e[1][0],u=+e[1][1]),R()):null==O?null:[[O,a],[s,u]]},S.scale=function(e){return arguments.length?(p=+e,P()):p},S.translate=function(e){return arguments.length?(d=+e[0],m=+e[1],P()):[d,m]},S.center=function(e){return arguments.length?(g=e[0]%360*h,y=e[1]%360*h,P()):[g*f,y*f]},S.rotate=function(e){return arguments.length?(v=e[0]%360*h,b=e[1]%360*h,_=e.length>2?e[2]%360*h:0,P()):[v*f,b*f,_*f]},S.precision=function(e){return arguments.length?(k=Jn(M,C=e*e),R()):E(C)},S.fitExtent=function(e,t){return Yn(S,e,t)},S.fitSize=function(e,t){return Gn(S,e,t)},S.fitWidth=function(e,t){return Qn(S,e,t)},S.fitHeight=function(e,t){return Kn(S,e,t)},function(){return t=e.apply(this,arguments),S.invert=t.invert&&A,P()}}function nr(e){var t=0,n=s/3,r=tr(e),i=r(t,n)
...
function n(e,n){return[e*t,w(n)/t]}return n.invert=function(e,n){return[e/t,C(n*t)]},n}(e)
var i=1+n*(2*r-n),o=E(i)/r
function s(e,t){var n=E(i-2*r*w(t))/r
return[n*w(e*=r),o-n*g(e)]}return s.invert=function(e,t){var n=o-t
return[m(e,p(n))/r*x(n),C((i-(e*e+n*n)*r*r)/(2*r))]},s}var ir=function(){return nr(rr).scale(155.424).center([0,33.6442])},or=function(){return ir().parallels([29.5,45.5]).scale(1070).translate([480,250]).rotate([96,0]).center([-.6,38.7])}
...
return[m(t*o,r*a),C(r&&n*o/r)]}}var ur=ar(function(e){return E(2/(1+e))})
ur.invert=sr(function(e){return 2*C(e/2)})
var cr=ar(function(e){return(e=T(e))&&e/w(e)})
...
function yr(e,t,n,r){return 1===e&&1===t&&0===n&&0===r?Qt:Hn({point:function(i,o){this.stream.point(i*e+n,o*t+r)}})}function vr(e,t){var n=t*t,r=n*n
...
function br(e,t){return[g(t)*w(e),w(t)]}br.invert=sr(C)
...
e.geoArea=function(e){return U.reset(),q(e,B),2*U},e.geoBounds=function(e){var t,n,r,i,o,a,s
if($=K=-(G=Q=1/0),ue=[],q(e,fe),n=ue.length){for(ue.sort(_e),t=1,o=[r=ue[0]];t<n;++t)we(r,(i=ue[t])[0])||we(r,i[1])?(be(r[0],i[1])>be(r[0],r[1])&&(r[1]=i[1]),be(i[0],r[1])>be(r[0],r[1])&&(r[0]=i[0])):o.push(r=i)
for(a=-1/0,t=0,r=o[n=o.length-1];t<=n;r=i,++t)i=o[t],(s=be(r[1],i[0]))>a&&(a=s,G=i[0],K=r[1])}return ue=ce=null,G===1/0||Q===1/0?[[NaN,NaN],[NaN,NaN]]:[[G,Q],[K,$]]},e.geoCentroid=function(e){xe=Ee=Oe=Te=Ce=ke=Se=Ae=Me=Pe=Re=0,q(e,Fe)
var t=Me,n=Pe,r=Re,i=t*t+n*n+r*r
return i<1e-12&&(t=ke,n=Se,r=Ae,Ee<a&&(t=Oe,n=Te,r=Ce),(i=t*t+n*n+r*r)<1e-12)?[NaN,NaN]:[m(n,t)*f,C(r/E(i))*f]},e.geoCircle=function(){var e,t,n=Ke([0,0]),r=Ke(90),i=Ke(6),o={point:function(n,r){e.push(n=t(n,r)),n[0]*=f,n[1]*=f}}
function a(){var a=n.apply(this,arguments),s=r.apply(this,arguments)*h,u=i.apply(this,arguments)*h
return e=[],t=Je(-a[0]*h,-a[1]*h,0).invert,rt(o,s,u,1),a={type:"Polygon",coordinates:[e]},e=t=null,a}return a.center=function(e){return arguments.length?(n="function"==typeof e?e:Ke([+e[0],+e[1]]),a):n},a.radius=function(e){return arguments.length?(r="function"==typeof e?e:Ke(+e),a):r},a.precision=function(e){return arguments.length?(i="function"==typeof e?e:Ke(+e),a):i},a},e.geoClipAntimeridian=mt,e.geoClipCircle=gt,e.geoClipExtent=function(){var e,t,n,r=0,i=0,o=960,a=500
return n={stream:function(n){return e&&t===n?e:e=_t(r,i,o,a)(t=n)},extent:function(s){return arguments.length?(r=+s[0][0],i=+s[0][1],o=+s[1][0],a=+s[1][1],e=t=null,n):[[r,i],[o,a]]}}},e.geoClipRectangle=_t,e.geoContains=function(e,t){return(e&&jt.hasOwnProperty(e.type)?jt[e.type]:Dt)(e,t)},e.geoDistance=Rt,e.geoGraticule=Ht,e.geoGraticule10=function(){return Ht()()},e.geoInterpolate=function(e,t){var n=e[0]*h,r=e[1]*h,i=t[0]*h,o=t[1]*h,a=g(r),s=w(r),u=g(o),c=w(o),l=a*g(n),p=a*w(n),d=u*g(i),y=u*w(i),v=2*C(E(k(o-r)+a*u*k(i-n))),b=w(v),_=v?function(e){var t=w(e*=v)/b,n=w(v-e)/b,r=n*l+t*d,i=n*p+t*y,o=n*s+t*c
return[m(i,r)*f,m(o,E(r*r+i*i))*f]}:function(){return[n*f,r*f]}
return _.distance=v,_},e.geoLength=At,e.geoPath=function(e,t){var n,r,i=4.5
function o(e){return e&&("function"==typeof i&&r.pointRadius(+i.apply(this,arguments)),q(e,n(r))),r.result()}return o.area=function(e){return q(e,n(Xt)),Xt.result()},o.measure=function(e){return q(e,n(Fn)),Fn.result()},o.bounds=function(e){return q(e,n(sn)),sn.result()},o.centroid=function(e){return q(e,n(wn)),wn.result()},o.projection=function(t){return arguments.length?(n=null==t?(e=null,Qt):(e=t).stream,o):e},o.context=function(e){return arguments.length?(r=null==e?(t=null,new Un):new Pn(t=e),"function"!=typeof i&&r.pointRadius(i),o):t},o.pointRadius=function(e){return arguments.length?(i="function"==typeof e?e:(r.pointRadius(+e),+e),o):i},o.projection(e).context(t)},e.geoAlbers=or,e.geoAlbersUsa=function(){var e,t,n,r,i,o,s=or(),u=ir().rotate([154,0]).center([-2,58.5]).parallels([55,65]),c=ir().rotate([157,0]).center([-3,19.9]).parallels([8,18]),l={point:function(e,t){o=[e,t]}}
...
return e}function T(){return 0}var C=function(e){return function(){return e}}
function k(e){return Math.sqrt(e.value)}function S(e){return function(t){t.children||(t.r=Math.max(0,+e(t)||0))}}function A(e,t){return function(n){if(r=n.children){var r,i,o,a=r.length,s=e(n)*t||0
if(s)for(i=0;i<a;++i)r[i].r+=s
if(o=E(r),s)for(i=0;i<a;++i)r[i].r-=s
n.r=o+s}}}function M(e){return function(t){var n=t.parent
t.r*=e,n&&(t.x=n.x+e*t.x,t.y=n.y+e*t.y)}}var P=function(e){e.x0=Math.round(e.x0),e.y0=Math.round(e.y0),e.x1=Math.round(e.x1),e.y1=Math.round(e.y1)},R=function(e,t,n,r,i){for(var o,a=e.children,s=-1,u=a.length,c=e.value&&(r-t)/e.value;++s<u;)(o=a[s]).y0=n,o.y1=i,o.x0=t,o.x1=t+=o.value*c},j="$",N={depth:-1},D={}
function L(e){return e.id}function I(e){return e.parentId}function F(e,t){return e.parent===t.parent?1:2}function q(e){var t=e.children
...
break}d=p}y.push(a={value:l,dice:u<c,children:v.slice(b,_)}),a.dice?R(a,n,r,i,x?r+=c*l/x:o):V(a,n,r,x?n+=u*l/x:i,o),x-=l,b=_}return y}var G=function e(t){function n(e,n,r,i,o){Y(t,e,n,r,i,o)}return n.ratio=function(t){return e((t=+t)>1?t:1)},n}(W),Q=function e(t){function n(e,n,r,i,o){if((a=e._squarify)&&a.ratio===t)for(var a,s,u,c,l,f=-1,h=a.length,p=e.value;++f<h;){for(u=(s=a[f]).children,c=s.value=0,l=u.length;c<l;++c)s.value+=u[c].value
s.dice?R(s,n,r,i,r+=(o-r)*s.value/p):V(s,n,r,n+=(i-n)*s.value/p,o),p-=s.value}else e._squarify=a=Y(t,e,n,r,i,o),a.ratio=t}return n.ratio=function(t){return e((t=+t)>1?t:1)},n}(W)
...
return t.eachAfter(a?function(e){e.x=(e.x-t.x)*i,e.y=(t.y-e.y)*o}:function(e){e.x=(e.x-f)/(h-f)*i,e.y=(1-(t.y?e.y/t.y:1))*o})}return s.separation=function(t){return arguments.length?(e=t,s):e},s.size=function(e){return arguments.length?(a=!1,i=+e[0],o=+e[1],s):a?null:[i,o]},s.nodeSize=function(e){return arguments.length?(a=!0,i=+e[0],o=+e[1],s):a?[i,o]:null},s},e.hierarchy=o,e.pack=function(){var e=null,t=1,n=1,r=T
function i(i){return i.x=t/2,i.y=n/2,e?i.eachBefore(S(e)).eachAfter(A(r,.5)).eachBefore(M(1)):i.eachBefore(S(k)).eachAfter(A(T,1)).eachAfter(A(r,i.r/Math.min(t,n))).eachBefore(M(Math.min(t,n)/(2*i.r))),i}return i.radius=function(t){return arguments.length?(e=null==(n=t)?null:O(n),i):e
var n},i.size=function(e){return arguments.length?(t=+e[0],n=+e[1],i):[t,n]},i.padding=function(e){return arguments.length?(r="function"==typeof e?e:C(+e),i):r},i},e.packSiblings=function(e){return E(e),e},e.packEnclose=f,e.partition=function(){var e=1,t=1,n=0,r=!1
function i(i){var o=i.height+1
return i.x0=i.y0=n,i.x1=e,i.y1=t/o,i.eachBefore(function(e,t){return function(r){r.children&&R(r,r.x0,e*(r.depth+1)/t,r.x1,e*(r.depth+2)/t)
...
for(i=0;i<h;++i)r=n[i],s=p[i]=new c(r),null!=(l=e(r,i,n))&&(l+="")&&(d[f=j+(s.id=l)]=f in d?D:s)
for(i=0;i<h;++i)if(s=p[i],null!=(l=t(n[i],i,n))&&(l+="")){if(!(a=d[j+l]))throw new Error("missing: "+l)
...
return o}return n.id=function(t){return arguments.length?(e=O(t),n):e},n.parentId=function(e){return arguments.length?(t=O(e),n):t},n},e.tree=function(){var e=F,t=1,n=1,r=null
...
t.parent.A=function(t,n,r){if(n){for(var i,o=t,a=t,s=n,u=o.parent.children[0],c=o.m,l=a.m,f=s.m,h=u.m;s=z(s),o=q(o),s&&o;)u=q(u),(a=z(a)).a=t,(i=s.z+f-o.z-c+e(s._,o._))>0&&(U(B(s,t,r),t,i),c+=i,l+=i),f+=s.m,c+=o.m,h+=u.m,l+=a.m
s&&!z(a)&&(a.t=s,a.m+=f-l),o&&!q(u)&&(u.t=o,u.m+=c-h,r=t)}return r}(t,i,t.parent.A||r[0])}function a(e){e._.x=e.z+e.parent.m,e.m+=e.parent.m}function s(e){e.x*=t,e.y=e.depth*n}return i.separation=function(t){return arguments.length?(e=t,i):e},i.size=function(e){return arguments.length?(r=!1,t=+e[0],n=+e[1],i):r?null:[t,n]},i.nodeSize=function(e){return arguments.length?(r=!0,t=+e[0],n=+e[1],i):r?[t,n]:null},i},e.treemap=function(){var e=G,t=!1,n=1,r=1,i=[0],o=T,a=T,s=T,u=T,c=T
...
f<r&&(r=f=(r+f)/2),h<l&&(l=h=(l+h)/2),t.x0=r,t.y0=l,t.x1=f,t.y1=h,t.children&&(n=i[t.depth+1]=o(t)/2,r+=c(t)-n,l+=a(t)-n,f-=s(t)-n,h-=u(t)-n,f<r&&(r=f=(r+f)/2),h<l&&(l=h=(l+h)/2),e(t,r,l,f,h))}return l.round=function(e){return arguments.length?(t=!!e,l):t},l.size=function(e){return arguments.length?(n=+e[0],r=+e[1],l):[n,r]},l.tile=function(t){return arguments.length?(e=O(t),l):e},l.padding=function(e){return arguments.length?l.paddingInner(e).paddingOuter(e):l.paddingInner()},l.paddingInner=function(e){return arguments.length?(o="function"==typeof e?e:C(+e),l):o},l.paddingOuter=function(e){return arguments.length?l.paddingTop(e).paddingRight(e).paddingBottom(e).paddingLeft(e):l.paddingTop()},l.paddingTop=function(e){return arguments.length?(a="function"==typeof e?e:C(+e),l):a},l.paddingRight=function(e){return arguments.length?(s="function"==typeof e?e:C(+e),l):s},l.paddingBottom=function(e){return arguments.length?(u="function"==typeof e?e:C(+e),l):u},l.paddingLeft=function(e){return arguments.length?(c="function"==typeof e?e:C(+e),l):c},l},e.treemapBinary=function(e,t,n,r,i){var o,a,s=e.children,u=s.length,c=new Array(u+1)
...
e(t,p,g,i,o,a,b),e(p,n,y,i,b,a,u)}})(0,u,e.value,t,n,r,i)},e.treemapDice=R,e.treemapSlice=V,e.treemapSliceDice=function(e,t,n,r,i){(1&e.depth?V:R)(e,t,n,r,i)},e.treemapSquarify=G,e.treemapResquarify=Q,Object.defineProperty(e,"__esModule",{value:!0})},"object"==typeof exports&&"undefined"!=typeof module?n(exports):"function"==typeof e&&e.amd?e(["exports"],n):n(t.d3=t.d3||{})}(function(){function e(){var e=Array.prototype.slice.call(arguments)
...
for(n in null!==e&&"object"==typeof e||(e={}),null!==t&&"object"==typeof t||(t={}),t)n in e?r[n]=T(e[n],t[n]):i[n]=t[n]
...
return s.join("")})},T=function(e,n){var r,i=typeof n
return null==n||"boolean"===i?o(n):("number"===i?g:"string"===i?(r=t.color(n))?(n=r,l):O:n instanceof t.color?l:n instanceof Date?m:Array.isArray(n)?d:"function"!=typeof n.valueOf&&"function"!=typeof n.toString||isNaN(n)?y:g)(e,n)},C=180/Math.PI,k={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1},S=function(e,t,n,r,i,o){var a,s,u
return(a=Math.sqrt(e*e+t*t))&&(e/=a,t/=a),(u=e*n+t*r)&&(n-=e*u,r-=t*u),(s=Math.sqrt(n*n+r*r))&&(n/=s,r/=s,u/=s),e*r<t*n&&(e=-e,t=-t,u=-u,a=-a),{translateX:i,translateY:o,rotate:Math.atan2(t,e)*C,skewX:Math.atan(u)*C,scaleX:a,scaleY:s}}
function A(e,t,n,r){function i(e){return e.length?e.pop()+" ":""}return function(o,a){var s=[],u=[]
...
return s.join("")}}}var M=A(function(e){return"none"===e?k:(_||(_=document.createElement("DIV"),w=document.documentElement,x=document.defaultView),_.style.transform=e,e=x.getComputedStyle(w.appendChild(_),null).getPropertyValue("transform"),w.removeChild(_),e=e.slice(7,-1).split(","),S(+e[0],+e[1],+e[2],+e[3],+e[4],+e[5]))},"px, ","px)","deg)"),P=A(function(e){return null==e?k:(E||(E=document.createElementNS("http://www.w3.org/2000/svg","g")),E.setAttribute("transform",e),(e=E.transform.baseVal.consolidate())?(e=e.matrix,S(e.a,e.b,e.c,e.d,e.e,e.f)):k)},", ",")",")"),R=Math.SQRT2
function j(e){return((e=Math.exp(e))+1/e)/2}function N(e){return function(n,r){var i=e((n=t.hsl(n)).h,(r=t.hsl(r)).h),o=c(n.s,r.s),a=c(n.l,r.l),s=c(n.opacity,r.opacity)
...
return function(e){return n.h=i(e),n.c=o(e),n.l=a(e),n.opacity=s(e),n+""}}}var F=I(s),q=I(c)
...
r=(y-g)/R,n=function(e){var t,n=e*r,s=j(g),u=a/(2*p)*(s*(t=R*n+g,((t=Math.exp(2*t))-1)/(t+1))-function(e){return((e=Math.exp(e))-1/e)/2}(g))
return[i+u*l,o+u*f,a*s/j(R*n+g)]}}return n.duration=1e3*r,n},e.interpolateRgb=l,e.interpolateRgbBasis=h,e.interpolateRgbBasisClosed=p,e.interpolateHsl=D,e.interpolateHslLong=L,e.interpolateLab=function(e,n){var r=c((e=t.lab(e)).l,(n=t.lab(n)).l),i=c(e.a,n.a),o=c(e.b,n.b),a=c(e.opacity,n.opacity)
return function(t){return e.l=r(t),e.a=i(t),e.b=o(t),e.opacity=a(t),e+""}},e.interpolateHcl=F,e.interpolateHclLong=q,e.interpolateCubehelix=U,e.interpolateCubehelixLong=B,e.quantize=function(e,t){for(var n=new Array(t),r=0;r<t;++r)n[r]=e(r/(t-1))
...
function T(e,t){return(t=Math.log(t/e))?function(n){return Math.log(n/e)/t}:d(t)}function C(e,t){return e<0?function(n){return-Math.pow(-t,n)*Math.pow(-e,1-n)}:function(n){return Math.pow(t,n)*Math.pow(e,1-n)}}function k(e){return isFinite(e)?+("1e"+e):e<0?0:e}function S(e){return 10===e?k:e===Math.E?Math.exp:function(t){return Math.pow(e,t)}}function A(e){return e===Math.E?Math.log:10===e&&Math.log10||2===e&&Math.log2||(e=Math.log(e),function(t){return Math.log(t)/e})}function M(e){return function(t){return-e(-t)}}function P(e,t){return e<0?-Math.pow(-e,t):Math.pow(e,t)}function R(){var e=1,t=w(function(t,n){return(n=P(n,e)-(t=P(t,e)))?function(r){return(P(r,e)-t)/n}:d(n)},function(t,n){return n=P(n,e)-(t=P(t,e)),function(r){return P(t+n*r,1/e)}}),n=t.domain
return t.exponent=function(t){return arguments.length?(e=+t,n(n())):e},t.copy=function(){return _(t,R().exponent(e))},E(t)}var j=1e3,N=60*j,D=60*N,L=24*D,I=7*L,F=30*L,q=365*L
function z(e){return new Date(e)}function U(e){return e instanceof Date?+e:+new Date(+e)}function B(e,n,i,o,a,s,u,l,f){var h=w(y,r.interpolateNumber),p=h.invert,d=h.domain,m=f(".%L"),g=f(":%S"),v=f("%I:%M"),b=f("%I %p"),x=f("%a %d"),E=f("%b %d"),T=f("%B"),C=f("%Y"),k=[[u,1,j],[u,5,5*j],[u,15,15*j],[u,30,30*j],[s,1,N],[s,5,5*N],[s,15,15*N],[s,30,30*N],[a,1,D],[a,3,3*D],[a,6,6*D],[a,12,12*D],[o,1,L],[o,2,2*L],[i,1,I],[n,1,F],[n,3,3*F],[e,1,q]]
function S(t){return(u(t)<t?m:s(t)<t?g:a(t)<t?v:o(t)<t?b:n(t)<t?i(t)<t?x:E:e(t)<t?T:C)(t)}function A(n,r,i,o){if(null==n&&(n=10),"number"==typeof n){var a=Math.abs(i-r)/n,s=t.bisector(function(e){return e[2]}).right(k,a)
s===k.length?(o=t.tickStep(r/q,i/q,n),n=e):s?(o=(s=k[a/k[s-1][2]<k[s][2]/a?s-1:s])[1],n=s[0]):(o=Math.max(t.tickStep(r,i,n),1),n=l)}return null==o?n:n.every(o)}return h.invert=function(e){return new Date(p(e))},h.domain=function(e){return arguments.length?d(c.call(e,U)):d().map(z)},h.ticks=function(e,t){var n,r=d(),i=r[0],o=r[r.length-1],a=o<i
return a&&(n=i,i=o,o=n),n=(n=A(e,i,o,t))?n.range(i,o+1):[],a?n.reverse():n},h.tickFormat=function(e,t){return null==t?S:f(t)},h.nice=function(e,t){var n=d()
return(e=A(e,n[0],n[n.length-1],t))?d(O(n,e)):h},h.copy=function(){return _(h,B(e,n,i,o,a,s,u,l,f))},h}var H=function(e){return e.match(/.{6}/g).map(function(e){return"#"+e})},V=H("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),W=H("393b795254a36b6ecf9c9ede6379398ca252b5cf6bcedb9c8c6d31bd9e39e7ba52e7cb94843c39ad494ad6616be7969c7b4173a55194ce6dbdde9ed6"),Y=H("3182bd6baed69ecae1c6dbefe6550dfd8d3cfdae6bfdd0a231a35474c476a1d99bc7e9c0756bb19e9ac8bcbddcdadaeb636363969696bdbdbdd9d9d9"),G=H("1f77b4aec7e8ff7f0effbb782ca02c98df8ad62728ff98969467bdc5b0d58c564bc49c94e377c2f7b6d27f7f7fc7c7c7bcbd22dbdb8d17becf9edae5"),Q=r.interpolateCubehelixLong(s.cubehelix(300,.5,0),s.cubehelix(-240,.5,1)),K=r.interpolateCubehelixLong(s.cubehelix(-100,.75,.35),s.cubehelix(80,1.5,.8)),$=r.interpolateCubehelixLong(s.cubehelix(260,.75,.35),s.cubehelix(80,1.5,.8)),X=s.cubehelix()
...
return t.copy=function(){return _(t,e())},E(t)},e.scaleLog=function e(){var n=w(T,C).domain([1,10]),r=n.domain,o=10,a=A(10),s=S(10)
function u(){return a=A(o),s=S(o),r()[0]<0&&(a=M(a),s=M(s)),n}return n.base=function(e){return arguments.length?(o=+e,u()):o},n.domain=function(e){return arguments.length?(r(e),u()):r()},n.ticks=function(e){var n,i=r(),u=i[0],c=i[i.length-1];(n=c<u)&&(p=u,u=c,c=p)
...
return n*o<o-.5&&(n*=o),n<=r?t(e):""}},n.nice=function(){return r(O(r(),{floor:function(e){return s(Math.floor(a(e)))},ceil:function(e){return s(Math.ceil(a(e)))}}))},n.copy=function(){return _(n,e().base(o))},n},e.scaleOrdinal=h,e.scaleImplicit=f,e.scalePow=R,e.scaleSqrt=function(){return R().exponent(.5)},e.scaleQuantile=function e(){var n=[],r=[],i=[]
...
return[n[t-1],n[t]]},o.copy=function(){return e().domain(n).range(r)},o},e.scaleTime=function(){return B(o.timeYear,o.timeMonth,o.timeWeek,o.timeDay,o.timeHour,o.timeMinute,o.timeSecond,o.timeMillisecond,a.timeFormat).domain([new Date(2e3,0,1),new Date(2e3,0,2)])},e.scaleUtc=function(){return B(o.utcYear,o.utcMonth,o.utcWeek,o.utcDay,o.utcHour,o.utcMinute,o.utcSecond,o.utcMillisecond,a.utcFormat).domain([Date.UTC(2e3,0,1),Date.UTC(2e3,0,2)])},e.schemeCategory10=V,e.schemeCategory20b=W,e.schemeCategory20c=Y,e.schemeCategory20=G,e.interpolateCubehelixDefault=Q,e.interpolateRainbow=function(e){(e<0||e>1)&&(e-=Math.floor(e))
var t=Math.abs(e-.5)
return X.h=360*e-100,X.s=1.5-1.5*t,X.l=.8-.9*t,X+""},e.interpolateWarm=K,e.interpolateCool=$,e.interpolateViridis=Z,e.interpolateMagma=ee,e.interpolateInferno=te,e.interpolatePlasma=ne,e.scaleSequential=function e(t){var n=0,r=1,i=!1
...
if(t){for(var n,r=0,i=-1,o=t.length;r<o;++r)n=t[r],e.type&&n.type!==e.type||n.name!==e.name?t[++i]=n:this.removeEventListener(n.type,n.listener,n.capture);++i?t.length=i:delete this.__on}}}function F(e,t,n){var r=N.hasOwnProperty(e.type)?D:L
...
this.addEventListener(e.type,c,n),s={type:e.type,name:e.name,value:t,listener:c,capture:n},u?u.push(s):this.__on=[s]}}function q(e,t,n){var r=b(e),i=r.CustomEvent
...
return!0}return this.each(("function"==typeof t?function(e,t){return function(){(t.apply(this,arguments)?O:T)(this,e)}}:t?function(e){return function(){O(this,e)}}:function(e){return function(){T(this,e)}})(n,t))},text:function(e){return arguments.length?this.each(null==e?C:("function"==typeof e?function(e){return function(){var t=e.apply(this,arguments)
this.textContent=null==t?"":t}}:function(e){return function(){this.textContent=e}})(e)):this.node().textContent},html:function(e){return arguments.length?this.each(null==e?k:("function"==typeof e?function(e){return function(){var t=e.apply(this,arguments)
this.innerHTML=null==t?"":t}}:function(e){return function(){this.innerHTML=e}})(e)):this.node().innerHTML},raise:function(){return this.each(S)},lower:function(){return this.each(A)},append:function(e){var t="function"==typeof e?e:i(e)
...
return this.select(function(){return this.insertBefore(n.apply(this,arguments),r.apply(this,arguments)||null)})},remove:function(){return this.each(P)},clone:function(e){return this.select(e?j:R)},datum:function(e){return arguments.length?this.property("__data__",e):this.node().__data__},on:function(e,t,n){var r,i,o=function(e){return e.trim().split(/^|\s+/).map(function(e){var t="",n=e.indexOf(".")
return n>=0&&(t=e.slice(n+1),e=e.slice(0,n)),{type:e,name:t}})}(e+""),a=o.length
if(!(arguments.length<2)){for(s=t?F:I,null==n&&(n=!1),r=0;r<a;++r)this.each(s(o[r],t,n))
return this}var s=this.node().__on
if(s)for(var u,c=0,l=s.length;c<l;++c)for(r=0,u=s[c];r<a;++r)if((i=o[r]).type===u.type&&i.name===u.name)return u.value},dispatch:function(e,t){return this.each(("function"==typeof t?function(e,t){return function(){return q(this,e,t.apply(this,arguments))}}:function(e,t){return function(){return q(this,e,t)}})(e,t))}}
var V=0
function W(){return new Y}function Y(){this._="@"+(++V).toString(36)}function G(){for(var t,n=e.event;t=n.sourceEvent;)n=t
return n}function Q(e,t){var n=e.ownerSVGElement||e
...
return t.changedTouches&&(t=t.changedTouches[0]),Q(e,t)},e.namespace=r,e.namespaces=n,e.clientPoint=Q,e.select=H,e.selectAll=function(e){return"string"==typeof e?new U([document.querySelectorAll(e)],[document.documentElement]):new U([null==e?[]:e],z)},e.selection=B,e.selector=a,e.selectorAll=u,e.style=_,e.touch=function(e,t,n){arguments.length<3&&(n=t,t=G().changedTouches)
for(var r,i=0,o=t?t.length:0;i<o;++i)if((r=t[i]).identifier===n)return Q(e,r)
return null},e.touches=function(e,t){null==t&&(t=G().touches)
for(var n=0,r=t?t.length:0,i=new Array(r);n<r;++n)i[n]=Q(e,t[n])
...
var j=function(){return R(T().curve(A))},N=function(){var e=C().curve(A),t=e.curve,n=e.lineX0,r=e.lineX1,i=e.lineY0,o=e.lineY1
return e.angle=e.x,delete e.x,e.startAngle=e.x0,delete e.x0,e.endAngle=e.x1,delete e.x1,e.radius=e.y,delete e.y,e.innerRadius=e.y0,delete e.y0,e.outerRadius=e.y1,delete e.y1,e.lineStartAngle=function(){return R(n())},delete e.lineX0,e.lineEndAngle=function(){return R(r())},delete e.lineX1,e.lineInnerRadius=function(){return R(i())},delete e.lineY0,e.lineOuterRadius=function(){return R(o())},delete e.lineY1,e.curve=function(e){return arguments.length?t(P(e)):t()._curve},e},D=function(e,t){return[(t=+t)*Math.cos(e-=Math.PI/2),t*Math.sin(e)]},L=Array.prototype.slice
function I(e){return e.source}function F(e){return e.target}function q(e){var r=I,i=F,o=E,a=O,s=null
...
e.moveTo(0,-n),e.lineTo(r,0),e.lineTo(0,n),e.lineTo(-r,0),e.closePath()}},Q=Math.sin(f/10)/Math.sin(7*f/10),K=Math.sin(p/10)*Q,$=-Math.cos(p/10)*Q,X={draw:function(e,t){var n=Math.sqrt(.8908130915292852*t),r=K*n,i=$*n
...
break
default:we(this,e,t)}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=t}}
var Te=function e(t){function n(e){return t?new Oe(e,t):new ye(e,0)}return n.alpha=function(t){return e(+t)},n}(.5)
function Ce(e,t){this._context=e,this._alpha=t}Ce.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._x2=this._y0=this._y1=this._y2=NaN,this._l01_a=this._l12_a=this._l23_a=this._l01_2a=this._l12_2a=this._l23_2a=this._point=0},lineEnd:function(){(this._line||0!==this._line&&3===this._point)&&this._context.closePath(),this._line=1-this._line},point:function(e,t){if(e=+e,t=+t,this._point){var n=this._x2-e,r=this._y2-t
...
case 3:this._point=4
default:we(this,e,t)}this._l01_a=this._l12_a,this._l12_a=this._l23_a,this._l01_2a=this._l12_2a,this._l12_2a=this._l23_2a,this._x0=this._x1,this._x1=this._x2,this._x2=e,this._y0=this._y1,this._y1=this._y2,this._y2=t}}
var ke=function e(t){function n(e){return t?new Ce(e,t):new be(e,0)}return n.alpha=function(t){return e(+t)},n}(.5)
function Se(e){this._context=e}Se.prototype={areaStart:se,areaEnd:se,lineStart:function(){this._point=0},lineEnd:function(){this._point&&this._context.closePath()},point:function(e,t){e=+e,t=+t,this._point?this._context.lineTo(e,t):(this._point=1,this._context.moveTo(e,t))}}
function Ae(e){return e<0?-1:1}function Me(e,t,n){var r=e._x1-e._x0,i=t-e._x1,o=(e._y1-e._y0)/(r||i<0&&-0),a=(n-e._y1)/(i||r<0&&-0),s=(o*i+a*r)/(r+i)
return(Ae(o)+Ae(a))*Math.min(Math.abs(o),Math.abs(a),.5*Math.abs(s))||0}function Pe(e,t){var n=e._x1-e._x0
return n?(3*(e._y1-e._y0)/n-t)/2:t}function Re(e,t,n){var r=e._x0,i=e._y0,o=e._x1,a=e._y1,s=(o-r)/3
e._context.bezierCurveTo(r+s,i+s*t,o-s,a-s*n,o,a)}function je(e){this._context=e}function Ne(e){this._context=new De(e)}function De(e){this._context=e}function Le(e){this._context=e}function Ie(e){var t,n,r=e.length-1,i=new Array(r),o=new Array(r),a=new Array(r)
...
return[i,o]}je.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=this._t0=NaN,this._point=0},lineEnd:function(){switch(this._point){case 2:this._context.lineTo(this._x1,this._y1)
break
case 3:Re(this,this._t0,Pe(this,this._t0))}(this._line||0!==this._line&&1===this._point)&&this._context.closePath(),this._line=1-this._line},point:function(e,t){var n=NaN
...
case 1:this._point=2
break
case 2:this._point=3,Re(this,Pe(this,n=Me(this,e,t)),n)
break
default:Re(this,this._t0,n=Me(this,e,t))}this._x0=this._x1,this._x1=e,this._y0=this._y1,this._y1=t,this._t0=n}}},(Ne.prototype=Object.create(je.prototype)).point=function(e,t){je.prototype.point.call(this,t,e)},De.prototype={moveTo:function(e,t){this._context.moveTo(t,e)},closePath:function(){this._context.closePath()},lineTo:function(e,t){this._context.lineTo(t,e)},bezierCurveTo:function(e,t,n,r,i,o){this._context.bezierCurveTo(t,e,r,n,o,i)}},Le.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x=[],this._y=[]},lineEnd:function(){var e=this._x,t=this._y,n=e.length
...
var qe=function(e,t){if((i=e.length)>1)for(var n,r,i,o=1,a=e[t[0]],s=a.length;o<i;++o)for(r=a,a=e[t[o]],n=0;n<s;++n)a[n][1]+=a[n][0]=isNaN(r[n][1])?r[n][0]:r[n][1]},ze=function(e){for(var t=e.length,n=new Array(t);--t>=0;)n[t]=t
return n}
...
return n}e.arc=function(){var e=m,a=g,w=n(0),x=null,E=y,O=v,T=b,C=null
function k(){var n,m,g,y=+e.apply(this,arguments),v=+a.apply(this,arguments),b=E.apply(this,arguments)-h,k=O.apply(this,arguments)-h,S=r(k-b),A=k>b
if(C||(C=n=t.path()),v<y&&(m=v,v=y,y=m),v>l)if(S>p-l)C.moveTo(v*o(b),v*u(b)),C.arc(0,0,v,b,k,!A),y>l&&(C.moveTo(y*o(k),y*u(k)),C.arc(0,0,y,k,b,A))
else{var M,P,R=b,j=k,N=b,D=k,L=S,I=S,F=T.apply(this,arguments)/2,q=F>l&&(x?+x.apply(this,arguments):c(y*y+v*v)),z=s(r(v-y)/2,+w.apply(this,arguments)),U=z,B=z
if(q>l){var H=d(q/y*u(F)),V=d(q/v*u(F));(L-=2*H)>l?(N+=H*=A?1:-1,D-=H):(L=0,N=D=(b+k)/2),(I-=2*V)>l?(R+=V*=A?1:-1,j-=V):(I=0,R=j=(b+k)/2)}var W=v*o(R),Y=v*u(R),G=y*o(D),Q=y*u(D)
if(z>l){var K=v*o(j),$=v*u(j),X=y*o(N),J=y*u(N)
if(S<f){var Z=L>l?function(e,t,n,r,i,o,a,s){var u=n-e,c=r-t,l=a-i,f=s-o,h=(l*(t-o)-f*(e-i))/(f*u-l*c)
return[e+h*u,t+h*c]}(W,Y,X,J,K,$,G,Q):[G,Q],ee=W-Z[0],te=Y-Z[1],ne=K-Z[0],re=$-Z[1],ie=1/u(((g=(ee*ne+te*re)/(c(ee*ee+te*te)*c(ne*ne+re*re)))>1?0:g<-1?f:Math.acos(g))/2),oe=c(Z[0]*Z[0]+Z[1]*Z[1])
U=s(z,(y-oe)/(ie-1)),B=s(z,(v-oe)/(ie+1))}}I>l?B>l?(M=_(X,J,W,Y,v,B,A),P=_(K,$,G,Q,v,B,A),C.moveTo(M.cx+M.x01,M.cy+M.y01),B<z?C.arc(M.cx,M.cy,B,i(M.y01,M.x01),i(P.y01,P.x01),!A):(C.arc(M.cx,M.cy,B,i(M.y01,M.x01),i(M.y11,M.x11),!A),C.arc(0,0,v,i(M.cy+M.y11,M.cx+M.x11),i(P.cy+P.y11,P.cx+P.x11),!A),C.arc(P.cx,P.cy,B,i(P.y11,P.x11),i(P.y01,P.x01),!A))):(C.moveTo(W,Y),C.arc(0,0,v,R,j,!A)):C.moveTo(W,Y),y>l&&L>l?U>l?(M=_(G,Q,K,$,y,-U,A),P=_(W,Y,X,J,y,-U,A),C.lineTo(M.cx+M.x01,M.cy+M.y01),U<z?C.arc(M.cx,M.cy,U,i(M.y01,M.x01),i(P.y01,P.x01),!A):(C.arc(M.cx,M.cy,U,i(M.y01,M.x01),i(M.y11,M.x11),!A),C.arc(0,0,y,i(M.cy+M.y11,M.cx+M.x11),i(P.cy+P.y11,P.cx+P.x11),A),C.arc(P.cx,P.cy,U,i(P.y11,P.x11),i(P.y01,P.x01),!A))):C.arc(0,0,y,D,N,A):C.lineTo(G,Q)}else C.moveTo(0,0)
if(C.closePath(),n)return C=null,n+""||null}return k.centroid=function(){var t=(+e.apply(this,arguments)+ +a.apply(this,arguments))/2,n=(+E.apply(this,arguments)+ +O.apply(this,arguments))/2-f/2
return[o(n)*t,u(n)*t]},k.innerRadius=function(t){return arguments.length?(e="function"==typeof t?t:n(+t),k):e},k.outerRadius=function(e){return arguments.length?(a="function"==typeof e?e:n(+e),k):a},k.cornerRadius=function(e){return arguments.length?(w="function"==typeof e?e:n(+e),k):w},k.padRadius=function(e){return arguments.length?(x=null==e?null:"function"==typeof e?e:n(+e),k):x},k.startAngle=function(e){return arguments.length?(E="function"==typeof e?e:n(+e),k):E},k.endAngle=function(e){return arguments.length?(O="function"==typeof e?e:n(+e),k):O},k.padAngle=function(e){return arguments.length?(T="function"==typeof e?e:n(+e),k):T},k.context=function(e){return arguments.length?(C=null==e?null:e,k):C},k},e.area=C,e.line=T,e.pie=function(){var e=S,t=k,r=null,i=n(0),o=n(p),a=n(0)
...
return r(l,a),l}return o.keys=function(t){return arguments.length?(e="function"==typeof t?t:n(L.call(t)),o):e},o.value=function(e){return arguments.length?(i="function"==typeof e?e:n(+e),o):i},o.order=function(e){return arguments.length?(t=null==e?ze:"function"==typeof e?e:n(L.call(e)),o):t},o.offset=function(e){return arguments.length?(r=null==e?qe:e,o):r},o},e.stackOffsetExpand=function(e,t){if((r=e.length)>0){for(var n,r,i,o=0,a=e[0].length;o<a;++o){for(i=n=0;n<r;++n)i+=e[n][o][1]||0
if(i)for(n=0;n<r;++n)e[n][o][1]/=i}qe(e,t)}},e.stackOffsetDiverging=function(e,t){if((s=e.length)>1)for(var n,r,i,o,a,s,u=0,c=e[t[0]].length;u<c;++u)for(o=a=0,n=0;n<s;++n)(i=(r=e[t[n]][u])[1]-r[0])>=0?(r[0]=o,r[1]=o+=i):i<0?(r[1]=a,r[0]=a+=i):r[0]=o},e.stackOffsetNone=qe,e.stackOffsetSilhouette=function(e,t){if((n=e.length)>0){for(var n,r=0,i=e[t[0]],o=i.length;r<o;++r){for(var a=0,s=0;a<n;++a)s+=e[a][r][1]||0
i[r][1]+=i[r][0]=-s/2}qe(e,t)}},e.stackOffsetWiggle=function(e,t){if((i=e.length)>0&&(r=(n=e[t[0]]).length)>0){for(var n,r,i,o=0,a=1;a<r;++a){for(var s=0,u=0,c=0;s<i;++s){for(var l=e[t[s]],f=l[a][1]||0,h=(f-(l[a-1][1]||0))/2,p=0;p<s;++p){var d=e[t[p]]
h+=(d[a][1]||0)-(d[a-1][1]||0)}u+=f,c+=h*f}n[a-1][1]+=n[a-1][0]=o,u&&(o-=c/u)}n[a-1][1]+=n[a-1][0]=o,qe(e,t)}},e.stackOrderAscending=Be,e.stackOrderDescending=function(e){return Be(e).reverse()},e.stackOrderInsideOut=function(e){var t,n,r=e.length,i=e.map(He),o=ze(e).sort(function(e,t){return i[t]-i[e]}),a=0,s=0,u=[],c=[]
...
function g(e){return r(function(t){t.setDate(t.getDate()-(t.getDay()+7-e)%7),t.setHours(0,0,0,0)},function(e,t){e.setDate(e.getDate()+7*t)},function(e,t){return(t-e-(t.getTimezoneOffset()-e.getTimezoneOffset())*a)/s})}var y=g(0),v=g(1),b=g(2),_=g(3),w=g(4),x=g(5),E=g(6),O=y.range,T=v.range,C=b.range,k=_.range,S=w.range,A=x.range,M=E.range,P=r(function(e){e.setDate(1),e.setHours(0,0,0,0)},function(e,t){e.setMonth(e.getMonth()+t)},function(e,t){return t.getMonth()-e.getMonth()+12*(t.getFullYear()-e.getFullYear())},function(e){return e.getMonth()}),R=P.range,j=r(function(e){e.setMonth(0,1),e.setHours(0,0,0,0)},function(e,t){e.setFullYear(e.getFullYear()+t)},function(e,t){return t.getFullYear()-e.getFullYear()},function(e){return e.getFullYear()})
j.every=function(e){return isFinite(e=Math.floor(e))&&e>0?r(function(t){t.setFullYear(Math.floor(t.getFullYear()/e)*e),t.setMonth(0,1),t.setHours(0,0,0,0)},function(t,n){t.setFullYear(t.getFullYear()+n*e)}):null}
var N=j.range,D=r(function(e){e.setUTCSeconds(0,0)},function(e,t){e.setTime(+e+t*a)},function(e,t){return(t-e)/a},function(e){return e.getUTCMinutes()}),L=D.range,I=r(function(e){e.setUTCMinutes(0,0,0)},function(e,t){e.setTime(+e+36e5*t)},function(e,t){return(t-e)/36e5},function(e){return e.getUTCHours()}),F=I.range,q=r(function(e){e.setUTCHours(0,0,0,0)},function(e,t){e.setUTCDate(e.getUTCDate()+t)},function(e,t){return(t-e)/864e5},function(e){return e.getUTCDate()-1}),z=q.range
function U(e){return r(function(t){t.setUTCDate(t.getUTCDate()-(t.getUTCDay()+7-e)%7),t.setUTCHours(0,0,0,0)},function(e,t){e.setUTCDate(e.getUTCDate()+7*t)},function(e,t){return(t-e)/s})}var B=U(0),H=U(1),V=U(2),W=U(3),Y=U(4),G=U(5),Q=U(6),K=B.range,$=H.range,X=V.range,J=W.range,Z=Y.range,ee=G.range,te=Q.range,ne=r(function(e){e.setUTCDate(1),e.setUTCHours(0,0,0,0)},function(e,t){e.setUTCMonth(e.getUTCMonth()+t)},function(e,t){return t.getUTCMonth()-e.getUTCMonth()+12*(t.getUTCFullYear()-e.getUTCFullYear())},function(e){return e.getUTCMonth()}),re=ne.range,ie=r(function(e){e.setUTCMonth(0,1),e.setUTCHours(0,0,0,0)},function(e,t){e.setUTCFullYear(e.getUTCFullYear()+t)},function(e,t){return t.getUTCFullYear()-e.getUTCFullYear()},function(e){return e.getUTCFullYear()})
...
var oe=ie.range
e.timeInterval=r,e.timeMillisecond=i,e.timeMilliseconds=o,e.utcMillisecond=i,e.utcMilliseconds=o,e.timeSecond=u,e.timeSeconds=c,e.utcSecond=u,e.utcSeconds=c,e.timeMinute=l,e.timeMinutes=f,e.timeHour=h,e.timeHours=p,e.timeDay=d,e.timeDays=m,e.timeWeek=y,e.timeWeeks=O,e.timeSunday=y,e.timeSundays=O,e.timeMonday=v,e.timeMondays=T,e.timeTuesday=b,e.timeTuesdays=C,e.timeWednesday=_,e.timeWednesdays=k,e.timeThursday=w,e.timeThursdays=S,e.timeFriday=x,e.timeFridays=A,e.timeSaturday=E
e.timeSaturdays=M,e.timeMonth=P,e.timeMonths=R,e.timeYear=j,e.timeYears=N,e.utcMinute=D,e.utcMinutes=L,e.utcHour=I,e.utcHours=F,e.utcDay=q,e.utcDays=z,e.utcWeek=B,e.utcWeeks=K,e.utcSunday=B,e.utcSundays=K,e.utcMonday=H,e.utcMondays=$,e.utcTuesday=V,e.utcTuesdays=X,e.utcWednesday=W,e.utcWednesdays=J,e.utcThursday=Y,e.utcThursdays=Z,e.utcFriday=G,e.utcFridays=ee,e.utcSaturday=Q,e.utcSaturdays=te,e.utcMonth=ne,e.utcMonths=re,e.utcYear=ie
...
return t.setUTCFullYear(e.y),t}return new Date(Date.UTC(e.y,e.m,e.d,e.H,e.M,e.S,e.L))}function i(e){return{y:e,m:0,d:1,H:0,M:0,S:0,L:0}}function o(e){var o=e.dateTime,a=e.date,u=e.time,c=e.periods,l=e.days,f=e.shortDays,h=e.months,ye=e.shortMonths,ve=p(c),be=d(c),_e=p(l),we=d(l),xe=p(f),Ee=d(f),Oe=p(h),Te=d(h),Ce=p(ye),ke=d(ye),Se={a:function(e){return f[e.getDay()]},A:function(e){return l[e.getDay()]},b:function(e){return ye[e.getMonth()]},B:function(e){return h[e.getMonth()]},c:null,d:N,e:N,f:q,H:D,I:L,j:I,L:F,m:z,M:U,p:function(e){return c[+(e.getHours()>=12)]},Q:me,s:ge,S:B,u:H,U:V,V:W,w:Y,W:G,x:null,X:null,y:Q,Y:K,Z:$,"%":de},Ae={a:function(e){return f[e.getUTCDay()]},A:function(e){return l[e.getUTCDay()]},b:function(e){return ye[e.getUTCMonth()]},B:function(e){return h[e.getUTCMonth()]},c:null,d:X,e:X,f:ne,H:J,I:Z,j:ee,L:te,m:re,M:ie,p:function(e){return c[+(e.getUTCHours()>=12)]},Q:me,s:ge,S:oe,u:ae,U:se,V:ue,w:ce,W:le,x:null,X:null,y:fe,Y:he,Z:pe,"%":de},Me={a:function(e,t,n){var r=xe.exec(t.slice(n))
return r?(e.w=Ee[r[0].toLowerCase()],n+r[0].length):-1},A:function(e,t,n){var r=_e.exec(t.slice(n))
return r?(e.w=we[r[0].toLowerCase()],n+r[0].length):-1},b:function(e,t,n){var r=Ce.exec(t.slice(n))
return r?(e.m=ke[r[0].toLowerCase()],n+r[0].length):-1},B:function(e,t,n){var r=Oe.exec(t.slice(n))
return r?(e.m=Te[r[0].toLowerCase()],n+r[0].length):-1},c:function(e,t,n){return je(e,o,t,n)},d:O,e:O,f:M,H:C,I:C,j:T,L:A,m:E,M:k,p:function(e,t,n){var r=ve.exec(t.slice(n))
return r?(e.p=be[r[0].toLowerCase()],n+r[0].length):-1},Q:R,s:j,S:S,u:g,U:y,V:v,w:m,W:b,x:function(e,t,n){return je(e,a,t,n)},X:function(e,t,n){return je(e,u,t,n)},y:w,Y:_,Z:x,"%":P}
...
return a.push(e.slice(c,u)),a.join("")}}function Re(e,n){return function(o){var a,s,u=i(1900)
if(je(u,e,o+="",0)!=o.length)return null
...
return"Z"in u?(u.H+=u.Z/100|0,u.M+=u.Z%100,r(u)):n(u)}}function je(e,t,n,r){for(var i,o,a=0,u=t.length,c=n.length;a<u;){if(r>=c)return-1
if(37===(i=t.charCodeAt(a++))){if(i=t.charAt(a++),!(o=Me[i in s?t.charAt(a++):i])||(r=o(e,n,r))<0)return-1}else if(i!=n.charCodeAt(r++))return-1}return r}return Se.x=Pe(a,Se),Se.X=Pe(u,Se),Se.c=Pe(o,Se),Ae.x=Pe(a,Ae),Ae.X=Pe(u,Ae),Ae.c=Pe(o,Ae),{format:function(e){var t=Pe(e+="",Se)
return t.toString=function(){return e},t},parse:function(e){var t=Re(e+="",n)
return t.toString=function(){return e},t},utcFormat:function(e){var t=Pe(e+="",Ae)
return t.toString=function(){return e},t},utcParse:function(e){var t=Re(e,r)
...
return r?(e.d=+r[0],n+r[0].length):-1}function T(e,t,n){var r=u.exec(t.slice(n,n+3))
return r?(e.m=0,e.d=+r[0],n+r[0].length):-1}function C(e,t,n){var r=u.exec(t.slice(n,n+2))
return r?(e.H=+r[0],n+r[0].length):-1}function k(e,t,n){var r=u.exec(t.slice(n,n+2))
return r?(e.M=+r[0],n+r[0].length):-1}function S(e,t,n){var r=u.exec(t.slice(n,n+2))
return r?(e.S=+r[0],n+r[0].length):-1}function A(e,t,n){var r=u.exec(t.slice(n,n+3))
...
var O=0
function T(e,t,n,r){this._groups=e,this._parents=t,this._name=n,this._id=r}function C(e){return t.selection().transition(e)}function k(){return++O}var S=t.selection.prototype
T.prototype=C.prototype={constructor:T,select:function(e){var n=this._name,r=this._id
...
return new T(a,this._parents,n,r)},selectAll:function(e){var n=this._name,r=this._id
...
a.push(d),s.push(c)}return new T(a,s,n,r)},filter:function(e){"function"!=typeof e&&(e=t.matcher(e))
...
return new T(i,this._parents,this._name,this._id)},merge:function(e){if(e._id!==this._id)throw new Error
...
for(;s<r;++s)a[s]=t[s]
return new T(a,this._parents,this._name,this._id)},selection:function(){return new E(this._groups,this._parents)},transition:function(){for(var e=this._name,t=this._id,n=k(),r=this._groups,i=r.length,o=0;o<i;++o)for(var a,s=r[o],u=s.length,c=0;c<u;++c)if(a=s[c]){var l=b(a,t)
g(a,e,n,c,s,{time:l.time+l.delay+l.duration,delay:0,duration:l.duration,ease:l.ease})}return new T(r,this._parents,e,n)},call:S.call,nodes:S.nodes,node:S.node,size:S.size,empty:S.empty,each:S.each,on:function(e,t){var n=this._id
...
var A={time:null,delay:0,duration:250,ease:a.easeCubicInOut}
function M(e,t){for(var n;!(n=e.__transition)||!(n=n[t]);)if(!(e=e.parentNode))return A.time=r.now(),A
...
e instanceof T?(t=e._id,e=e._name):(t=k(),(n=A).time=r.now(),e=null==e?null:e+"")
for(var i=this._groups,o=i.length,a=0;a<o;++a)for(var s,u=i[a],c=u.length,l=0;l<c;++l)(s=u[l])&&g(s,e,t,l,u,n||M(s,t))
return new T(i,this._parents,e,t)}
var P=[null]
e.transition=C,e.active=function(e,t){var n,r,i=e.__transition
if(i)for(r in t=null==t?null:t+"",i)if((n=i[r]).state>l&&n.name===t)return new T([[e]],P,t,+r)
...
return i.left=e,i.right=t,n&&f(i,e,t,n),r&&f(i,t,e,r),A[e.index].halfedges.push(o),A[t.index].halfedges.push(o),i}function l(e,t,n){var r=[t,n]
...
if(!(p>=-j)){var d=c*c+l*l,m=f*f+h*h,g=(h*d-l*m)/p,b=(c*m-f*d)/p,_=v.pop()||new function(){o(this),this.x=this.y=this.arc=this.site=this.cy=null}
...
return t.site=e,t}function E(e){_(e),S.remove(e),w.push(e),o(e)}function O(e){var t=e.circle,n=t.x,r=t.cy,i=[n,r],o=e.P,a=e.N,s=[e]
E(e)
for(var u=o;u.circle&&Math.abs(n-u.circle.x)<R&&Math.abs(r-u.circle.cy)<R;)o=u.P,s.unshift(u),E(u),u=o
s.unshift(u),_(u)
for(var l=a;l.circle&&Math.abs(n-l.circle.x)<R&&Math.abs(r-l.circle.cy)<R;)a=l.N,s.push(l),E(l),l=a
s.push(l),_(l)
var h,p=s.length
for(h=1;h<p;++h)l=s[h],u=s[h-1],f(l.edge,u.site,l.site,i)
u=s[0],(l=s[p-1]).edge=c(u.site,l.site,null,i),b(u),b(l)}function T(e){for(var t,n,r,i,o=e[0],a=e[1],s=S._;s;)if((r=C(s,a)-o)>R)s=s.L
else{if(!((i=o-k(s,a))>R)){r>-R?(t=s.P,n=s):i>-R?(t=s,n=s.N):t=n=s
break}if(!s.R){t=s
break}s=s.R}(function(e){A[e.index]={site:e,halfedges:[]}})(e)
var u=x(e)
if(S.insert(t,u),t||n){if(t===n)return _(t),n=x(t.site),S.insert(u,n),u.edge=n.edge=c(t.site,u.site),b(t),void b(n)
if(n){_(t),_(n)
var l=t.site,h=l[0],p=l[1],d=e[0]-h,m=e[1]-p,g=n.site,y=g[0]-h,v=g[1]-p,w=2*(d*v-m*y),E=d*d+m*m,O=y*y+v*v,T=[(v*E-m*O)/w+h,(d*O-y*E)/w+p]
f(n.edge,l,g,T),u.edge=c(l,e,null,T),n.edge=c(e,g,null,T),b(t),b(n)}else u.edge=c(t.site,u.site)}}function C(e,t){var n=e.site,r=n[0],i=n[1],o=i-t
if(!o)return r
var a=e.P
if(!a)return-1/0
...
return f?(-h+Math.sqrt(h*h-2*f*(l*l/(-2*c)-u+c/2+i-o/2)))/f+r:(r+s)/2}function k(e,t){var n=e.N
if(n)return C(n,t)
var r=e.site
return r[1]===t?r[0]:1/0}var S,A,M,P,R=1e-6,j=1e-12
function N(e,t){return t[1]-e[1]||t[0]-e[0]}function D(e,t){var n,r,o,a=e.sort(N).pop()
for(P=[],A=new Array(e.length),S=new i,M=new i;;)if(o=y,a&&(!o||a[1]<o.y||a[1]===o.y&&a[0]<o.x))a[0]===n&&a[1]===r||(T(a),n=a[0],r=a[1]),a=e.pop()
else{if(!o)break
O(o.arc)}if(function(){for(var e,t,n,r,i=0,o=A.length;i<o;++i)if((e=A[i])&&(r=(t=e.halfedges).length)){var a=new Array(r),s=new Array(r)
for(n=0;n<r;++n)a[n]=n,s[n]=d(e,P[t[n]])
for(a.sort(function(e,t){return s[t]-s[e]}),n=0;n<r;++n)s[n]=t[a[n]]
for(n=0;n<r;++n)t[n]=s[n]}}(),t){var s=+t[0][0],u=+t[0][1],c=+t[1][0],f=+t[1][1];(function(e,t,n,r){for(var i,o=P.length;o--;)p(i=P[o],e,t,n,r)&&h(i,e,t,n,r)&&(Math.abs(i[0][0]-i[1][0])>R||Math.abs(i[0][1]-i[1][1])>R)||delete P[o]})(s,u,c,f),function(e,t,n,r){var i,o,a,s,u,c,f,h,p,d,y,v,b=A.length,_=!0
for(i=0;i<b;++i)if(o=A[i]){for(a=o.site,s=(u=o.halfedges).length;s--;)P[u[s]]||u.splice(s,1)
for(s=0,c=u.length;s<c;)y=(d=g(o,P[u[s]]))[0],v=d[1],h=(f=m(o,P[u[++s%c]]))[0],p=f[1],(Math.abs(y-h)>R||Math.abs(v-p)>R)&&(u.splice(s,0,P.push(l(a,d,Math.abs(y-e)<R&&r-v>R?[e,Math.abs(h-e)<R?p:r]:Math.abs(v-r)<R&&n-y>R?[Math.abs(p-r)<R?h:n,r]:Math.abs(y-n)<R&&v-t>R?[n,Math.abs(h-n)<R?p:t]:Math.abs(v-t)<R&&y-e>R?[Math.abs(p-t)<R?h:e,t]:null))-1),++c)
c&&(_=!1)}if(_){var w,x,E,O=1/0
for(i=0,_=null;i<b;++i)(o=A[i])&&(E=(w=(a=o.site)[0]-e)*w+(x=a[1]-t)*x)<O&&(O=E,_=o)
if(_){var T=[e,t],C=[e,r],k=[n,r],S=[n,t]
_.halfedges.push(P.push(l(a=_.site,T,C))-1,P.push(l(a,C,k))-1,P.push(l(a,k,S))-1,P.push(l(a,S,T))-1)}}for(i=0;i<b;++i)(o=A[i])&&(o.halfedges.length||delete A[i])}(s,u,c,f)}this.edges=P,this.cells=A,S=M=P=A=null}D.prototype={constructor:D,polygons:function(){var e=this.edges
...
function a(t){return new D(t.map(function(n,r){var o=[Math.round(e(n,r,t)/R)*R,Math.round(i(n,r,t)/R)*R]
...
return e.translate(i>r?(r+i)/2:Math.min(0,r)||Math.max(0,i),a>o?(o+a)/2:Math.min(0,o)||Math.max(0,a))}e.zoom=function(){var e,c,v=h,b=p,_=y,w=m,x=g,E=[0,1/0],O=[[-1/0,-1/0],[1/0,1/0]],T=250,C=r.interpolateZoom,k=[],S=t.dispatch("start","zoom","end"),A=500,M=150,P=0
function R(e){e.property("__zoom",d).on("wheel.zoom",q).on("mousedown.zoom",z).on("dblclick.zoom",U).filter(x).on("touchstart.zoom",B).on("touchmove.zoom",H).on("touchend.zoom touchcancel.zoom",V).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function j(e,t){return(t=Math.max(E[0],Math.min(E[1],t)))===e.k?e:new s(t,e.x,e.y)}function N(e,t,n){var r=t[0]-n[0]*e.k,i=t[1]-n[1]*e.k
return r===e.x&&i===e.y?e:new s(e.k,r,i)}function D(e){return[(+e[0][0]+ +e[1][0])/2,(+e[0][1]+ +e[1][1])/2]}function L(e,t,n){e.on("start.zoom",function(){I(this,arguments).start()}).on("interrupt.zoom end.zoom",function(){I(this,arguments).end()}).tween("zoom",function(){var e=arguments,r=I(this,e),i=b.apply(this,e),o=n||D(i),a=Math.max(i[1][0]-i[0][0],i[1][1]-i[0][1]),u=this.__zoom,c="function"==typeof t?t.apply(this,e):t,l=C(u.invert(o).concat(a/u.k),c.invert(o).concat(a/c.k))
return function(e){if(1===e)e=c
else{var t=l(e),n=a/t[2]
e=new s(n,o[0]-t[0]*n,o[1]-t[1]*n)}r.zoom(null,e)}})}function I(e,t){for(var n,r=0,i=k.length;r<i;++r)if((n=k[r]).that===e)return n
return new F(e,t)}function F(e,t){this.that=e,this.args=t,this.index=-1,this.active=0,this.extent=b.apply(e,t)}function q(){if(v.apply(this,arguments)){var e=I(this,arguments),t=this.__zoom,n=Math.max(E[0],Math.min(E[1],t.k*Math.pow(2,w.apply(this,arguments)))),r=i.mouse(this)
if(e.wheel)e.mouse[0][0]===r[0]&&e.mouse[0][1]===r[1]||(e.mouse[1]=t.invert(e.mouse[0]=r)),clearTimeout(e.wheel)
else{if(t.k===n)return
e.mouse=[r,t.invert(r)],o.interrupt(this),e.start()}f(),e.wheel=setTimeout(function(){e.wheel=null,e.end()},M),e.zoom("mouse",_(N(j(t,n),e.mouse[0],e.mouse[1]),e.extent,O))}}function z(){if(!c&&v.apply(this,arguments)){var e=I(this,arguments),t=i.select(i.event.view).on("mousemove.zoom",function(){if(f(),!e.moved){var t=i.event.clientX-a,n=i.event.clientY-s
...
n.dragDisable(i.event.view),l(),e.mouse=[r,this.__zoom.invert(r)],o.interrupt(this),e.start()}}function U(){if(v.apply(this,arguments)){var e=this.__zoom,t=i.mouse(this),n=e.invert(t),r=e.k*(i.event.shiftKey?.5:2),o=_(N(j(e,r),t,n),b.apply(this,arguments),O)
f(),T>0?i.select(this).transition().duration(T).call(L,o,t):i.select(this).call(R.transform,o)}}function B(){if(v.apply(this,arguments)){var t,n,r,a,s=I(this,arguments),u=i.event.changedTouches,c=u.length
...
t&&(e=setTimeout(function(){e=null},A),o.interrupt(this),s.start())}}function H(){var t,n,r,o,a=I(this,arguments),s=i.event.changedTouches,u=s.length
...
n=j(n,Math.sqrt(d/m)),r=[(c[0]+h[0])/2,(c[1]+h[1])/2],o=[(l[0]+p[0])/2,(l[1]+p[1])/2]}else{if(!a.touch0)return
...
for(l(),c&&clearTimeout(c),c=setTimeout(function(){c=null},A),e=0;e<o;++e)t=r[e],n.touch0&&n.touch0[2]===t.identifier?delete n.touch0:n.touch1&&n.touch1[2]===t.identifier&&delete n.touch1
n.touch1&&!n.touch0&&(n.touch0=n.touch1,delete n.touch1),n.touch0?n.touch0[1]=this.__zoom.invert(n.touch0[0]):n.end()}return R.transform=function(e,t){var n=e.selection?e.selection():e
n.property("__zoom",d),e!==n?L(e,t):n.interrupt().each(function(){I(this,arguments).start().zoom(null,"function"==typeof t?t.apply(this,arguments):t).end()})},R.scaleBy=function(e,t){R.scaleTo(e,function(){return this.__zoom.k*("function"==typeof t?t.apply(this,arguments):t)})},R.scaleTo=function(e,t){R.transform(e,function(){var e=b.apply(this,arguments),n=this.__zoom,r=D(e),i=n.invert(r),o="function"==typeof t?t.apply(this,arguments):t
return _(N(j(n,o),r,i),e,O)})},R.translateBy=function(e,t,n){R.transform(e,function(){return _(this.__zoom.translate("function"==typeof t?t.apply(this,arguments):t,"function"==typeof n?n.apply(this,arguments):n),b.apply(this,arguments),O)})},R.translateTo=function(e,t,n){R.transform(e,function(){var e=b.apply(this,arguments),r=this.__zoom,i=D(e)
return _(u.translate(i[0],i[1]).scale(r.k).translate("function"==typeof t?-t.apply(this,arguments):-t,"function"==typeof n?-n.apply(this,arguments):-n),e,O)})},F.prototype={start:function(){return 1==++this.active&&(this.index=k.push(this)-1,this.emit("start")),this},zoom:function(e,t){return this.mouse&&"mouse"!==e&&(this.mouse[1]=t.invert(this.mouse[0])),this.touch0&&"touch"!==e&&(this.touch0[1]=t.invert(this.touch0[0])),this.touch1&&"touch"!==e&&(this.touch1[1]=t.invert(this.touch1[0])),this.that.__zoom=t,this.emit("zoom"),this},end:function(){return 0==--this.active&&(k.splice(this.index,1),this.index=-1,this.emit("end")),this},emit:function(e){i.customEvent(new function(e,t,n){this.target=e,this.type=t,this.transform=n}(R,e,this.that.__zoom),S.apply,S,[e,this.that,this.args])}},R.wheelDelta=function(e){return arguments.length?(w="function"==typeof e?e:a(+e),R):w},R.filter=function(e){return arguments.length?(v="function"==typeof e?e:a(!!e),R):v},R.touchable=function(e){return arguments.length?(x="function"==typeof e?e:a(!!e),R):x},R.extent=function(e){return arguments.length?(b="function"==typeof e?e:a([[+e[0][0],+e[0][1]],[+e[1][0],+e[1][1]]]),R):b},R.scaleExtent=function(e){return arguments.length?(E[0]=+e[0],E[1]=+e[1],R):[E[0],E[1]]},R.translateExtent=function(e){return arguments.length?(O[0][0]=+e[0][0],O[1][0]=+e[1][0],O[0][1]=+e[0][1],O[1][1]=+e[1][1],R):[[O[0][0],O[0][1]],[O[1][0],O[1][1]]]},R.constrain=function(e){return arguments.length?(_=e,R):_},R.duration=function(e){return arguments.length?(T=+e,R):T},R.interpolate=function(e){return arguments.length?(C=e,R):C},R.on=function(){var e=S.on.apply(S,arguments)
return e===S?R:e},R.clickDistance=function(e){return arguments.length?(P=(e=+e)*e,R):Math.sqrt(P)},R},e.zoomTransform=c,e.zoomIdentity=u,Object.defineProperty(e,"__esModule",{value:!0})},"object"==typeof exports&&"undefined"!=typeof module?n(exports,require("d3-dispatch"),require("d3-drag"),require("d3-interpolate"),require("d3-selection"),require("d3-transition")):"function"==typeof e&&e.amd?e(["exports","d3-dispatch","d3-drag","d3-interpolate","d3-selection","d3-transition"],n):n(t.d3=t.d3||{},t.d3,t.d3,t.d3,t.d3,t.d3)}(function(){function e(){var e=Array.prototype.slice.call(arguments)
...
h.exit().transition(c).attr("r",0).remove(),h.enter().append("circle").attr("fill","red").attr("opacity",.5).attr("r",function(){return 0}).attr("cx",function(){return u/2}).attr("cy",function(e){return l(e.timestamp)}).merge(h).transition(c).attr("r",function(e){return f(e.value)/2}).attr("cx",function(){return u/2}).attr("cy",function(e){return l(e.timestamp)})}})}),define("building-blocks/components/charts/line-chart/component",["exports","building-blocks/components/charts/line-chart/template","d3-scale","d3-axis","d3-selection","d3-shape"],function(e,t,n,r,i,o){"use strict"
...
e.default=Ember.Component.extend({layout:t.default,tagName:"g",width:500,height:200,dataTestId:"line-chart",isLoading:!0,noDataAvailble:Ember.computed("data.[]",function(){var e=this.get("data")
return Ember.isEmpty(e)||!Ember.isArray(e)}),noChart:Ember.computed.or("isLoading","noDataAvailble"),noChartText:Ember.computed("width","height",function(){return{x:this.get("width")/2,y:this.get("height")/2}}),yTitle:null,yTitleText:Ember.computed("height",function(){var e=(this.get("height")-20+15)/2
return{x:10,y:e,transform:"translate(10, "+e+") rotate(270) translate(-10, -"+e+")"}}),yAxisTransform:Ember.computed(function(){return"translate(55, 15)"}),xAxisTransform:Ember.computed("height",function(){return"translate(55, "+(this.get("height")-20)+")"}),lineAxisTransform:Ember.computed(function(){return"translate(55, 15)"}),chartDimension:Ember.computed("width","height",function(){return{width:this.get("width")-20-35-15,height:this.get("height")-20-15}}),didReceiveAttrs:function(){this._super(),Ember.run.scheduleOnce("render",this,this.draw)},draw:function(){if(!this.get("noChart")){var e=this.get("data")
if(!Ember.isEmpty(e)&&Ember.isArray(e)){var t=(0,i.select)(this.element),s=e.mapBy("y"),u=(0,n.scaleLinear)().domain([Math.min.apply(Math,a(s)),Math.max.apply(Math,a(s))]).range([this.get("chartDimension.height"),0]),c=t.select("g.y-axis"),l=(0,r.axisLeft)(u).ticks(6)
c.call(l)
var f=e.mapBy("x"),h=(0,n.scaleLinear)().domain([Math.min.apply(Math,a(f)),Math.max.apply(Math,a(f))]).range([0,this.get("chartDimension.width")]),p=t.select("g.x-axis"),d=(0,r.axisBottom)(h).ticks(6)
p.call(d)
var m=t.select("path.svg-line"),g=(0,o.line)().x(function(e){return h(e.x)}).y(function(e){return u(e.y)})
m.datum(e).attr("d",g)}}},didInsertElement:function(){this._super.apply(this,arguments),this.addMouseEventHandlers()},willDestroyElement:function(){this._super.apply(this,arguments),this.removeMouseEventHandlers()},showTooltip:!1,addMouseEventHandlers:function(){var e=this
this.$("rect.svg-mouse-catch").on("mouseout",function(){e.set("showTooltip",!1)}),this.$("rect.svg-mouse-catch").on("mouseover",function(t){e.get("noChart")||e.handleMouseOver(t)}),this.$("rect.svg-mouse-catch").on("mousemove",function(t){e.get("noChart")||e.handleMouseOver(t)})},handleMouseOver:function(e){var t=void 0,n=e.clientX
t=n>window.innerWidth/2?"right: "+(n=window.innerWidth-n)+"px; ":"left: "+n+"px; "
var r=e.clientY
t=r>window.innerHeight/2?t+"bottom: "+(r=window.innerHeight-r)+"px;":t+"top: "+r+"px;",this.set("tooltipStyle",new Ember.String.htmlSafe(t))
var i=e.offsetX-70,o=this.get("data"),a=parseInt(Math.round(i*o.get("length")/this.get("chartDimension.width")))+1
a>=0&&a<o.length?(this.set("dataValue",o[a].y),this.set("offsetX",a*this.get("chartDimension.width")/(o.get("length")-1)),this.set("showTooltip",!0)):(this.set("dataValue",null),this.set("offsetX",null),this.set("showTooltip",!1))},removeMouseEventHandlers:function(){this.$("rect.svg-mouse-catch").off("mouseout"),this.$("rect.svg-mouse-catch").off("mouseover"),this.$("rect.svg-mouse-catch").off("mousemove")}})}),define("building-blocks/components/charts/line-chart/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"/2yzEhps",block:'{"symbols":["&default"],"statements":[[6,"svg"],[10,"width",[18,"width"],null],[10,"height",[18,"height"],null],[10,"data-test-id",[18,"dataTestId"],null],[7],[0,"\\n  "],[6,"g"],[9,"transform","translate(0, 0)"],[7],[0,"\\n"],[4,"if",[[20,["noChart"]]],null,{"statements":[[0,"      "],[6,"rect"],[10,"width",[18,"width"],null],[10,"height",[18,"height"],null],[9,"class","chart-grid"],[7],[0,"\\n      "],[8],[0,"\\n      "],[6,"text"],[10,"x",[20,["noChartText","x"]],null],[10,"y",[20,["noChartText","y"]],null],[9,"dy",".35em"],[9,"text-anchor","middle"],[7],[0,"\\n"],[4,"if",[[20,["isLoading"]]],null,{"statements":[[0,"          Loading\\n"]],"parameters":[]},{"statements":[[0,"          No data available\\n"]],"parameters":[]}],[0,"      "],[8],[0,"\\n"]],"parameters":[]},{"statements":[[0,"      "],[6,"text"],[10,"x",[20,["yTitleText","x"]],null],[10,"y",[20,["yTitleText","y"]],null],[10,"transform",[20,["yTitleText","transform"]],null],[7],[1,[18,"yTitle"],false],[8],[0,"\\n      "],[6,"g"],[9,"class","y-axis"],[10,"transform",[18,"yAxisTransform"],null],[7],[0,"\\n      "],[8],[0,"\\n      "],[6,"g"],[9,"class","x-axis"],[10,"transform",[18,"xAxisTransform"],null],[7],[0,"\\n      "],[8],[0,"\\n      "],[6,"g"],[9,"class","line"],[10,"transform",[18,"lineAxisTransform"],null],[7],[0,"\\n        "],[6,"rect"],[10,"width",[20,["chartDimension","width"]],null],[10,"height",[20,["chartDimension","height"]],null],[9,"pointer-events","all"],[9,"class","svg-mouse-catch"],[7],[8],[0,"\\n"],[4,"if",[[20,["showTooltip"]]],null,{"statements":[[0,"          "],[6,"line"],[10,"x1",[18,"offsetX"],null],[9,"y1","0"],[10,"x2",[18,"offsetX"],null],[10,"y2",[20,["chartDimension","height"]],null],[9,"class","svg-mouse-line"],[7],[8],[0,"\\n"]],"parameters":[]},null],[0,"        "],[6,"path"],[9,"class","svg-line svg-line-1"],[7],[8],[0,"\\n      "],[8],[0,"\\n"]],"parameters":[]}],[0,"  "],[8],[0,"\\n"],[8],[0,"\\n\\n"],[4,"if",[[20,["showTooltip"]]],null,{"statements":[[0,"  "],[6,"foreignObject"],[7],[0,"\\n    "],[6,"div"],[9,"class","svg-tooltip-tip"],[10,"style",[18,"tooltipStyle"],null],[7],[0,"\\n      "],[1,[18,"dataValue"],false],[0," "],[6,"br"],[7],[8],[0,"\\n      "],[11,1,[[25,"hash",null,[["tip"],[true]]]]],[0,"\\n    "],[8],[0,"\\n  "],[8],[0,"\\n"]],"parameters":[]},null]],"hasEval":false}',meta:{moduleName:"building-blocks/components/charts/line-chart/template.hbs"}})}),define("building-blocks/components/charts/progress-circle/component",["exports","building-blocks/components/charts/progress-circle/template","building-blocks/mixins/svg-base","d3-shape"],function(e,t,n,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(n.default,{layout:t.default,width:200,height:200,radius:100,progress:0,gTransform:Ember.computed("radius",function(){var e=this.get("radius")
return"translate("+e+", "+e+")"}),backgroundPathD:Ember.computed("radius",function(){var e=this.get("radius")
return(0,r.arc)().innerRadius(e-10).outerRadius(e).startAngle(0).endAngle(2*Math.PI)()}),progressPathD:Ember.computed("radius","progress",function(){var e=this.get("radius"),t=this.get("progress")
if(isNaN(t)||t<0||t>100)return""
var n=t*Math.PI*2/100
return(0,r.arc)().innerRadius(e-10).outerRadius(e).startAngle(0).endAngle(n)()})})}),define("building-blocks/components/charts/progress-circle/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"XA+SHxpO",block:'{"symbols":[],"statements":[[6,"text"],[10,"x",[18,"radius"],null],[10,"y",[18,"radius"],null],[9,"dy",".35em"],[9,"text-anchor","middle"],[7],[1,[18,"progress"],false],[0,"%"],[8],[0,"\\n"],[6,"g"],[10,"transform",[18,"gTransform"],null],[7],[0,"\\n  "],[6,"path"],[10,"d",[18,"backgroundPathD"],null],[9,"class","chart-grid"],[7],[8],[0,"\\n  "],[6,"path"],[10,"d",[18,"progressPathD"],null],[9,"class","chart-fill"],[7],[8],[0,"\\n"],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/charts/progress-circle/template.hbs"}})}),define("building-blocks/components/icon-component/component",["exports","building-blocks/components/icon-component/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=Ember.Component.extend({layout:t.default,tagName:"",dataTestId:"icon-component",status:"default",size:1,iconComponentName:Ember.computed("icon",function(){return"icons/"+this.get("icon")+"-icon"}),width:Ember.computed("size",function(){return 20*(this.get("size")/2+1)}),radius:Ember.computed("width",function(){return this.get("width")/2})})}),define("building-blocks/components/icon-component/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"5C2gONQ0",block:'{"symbols":["wrapper"],"statements":[[4,"svg-tooltip-wrapper",null,null,{"statements":[[4,"if",[[19,1,["target"]]],null,{"statements":[[0,"    "],[1,[25,"component",[[20,["iconComponentName"]]],[["width","height","radius","dataTestId","status"],[[20,["width"]],[20,["width"]],[20,["radius"]],[20,["dataTestId"]],[20,["status"]]]]],false],[0,"\\n"]],"parameters":[]},null],[4,"if",[[25,"and",[[19,1,["tip"]],[20,["tooltip"]]],null]],null,{"statements":[[0,"    "],[1,[18,"tooltip"],false],[0,"\\n"]],"parameters":[]},null]],"parameters":[1]},null]],"hasEval":false}',meta:{moduleName:"building-blocks/components/icon-component/template.hbs"}})}),define("building-blocks/components/icons/facebook-icon/component",["exports","building-blocks/components/icons/facebook-icon/template","building-blocks/mixins/svg-base"],function(e,t,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(n.default,{layout:t.default})}),define("building-blocks/components/icons/facebook-icon/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"HQSnGBPG",block:'{"symbols":[],"statements":[[6,"svg"],[9,"viewBox","0 0 24 24"],[7],[0,"\\n  "],[6,"path"],[10,"class",[25,"concat",["svg-",[20,["status"]]],null],null],[9,"d","M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z"],[7],[8],[0,"\\n"],[8],[0,"\\n"],[6,"circle"],[9,"class","svg-hover-background"],[10,"cx",[18,"radius"],null],[10,"cy",[18,"radius"],null],[10,"r",[18,"radius"],null],[7],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/icons/facebook-icon/template.hbs"}})}),define("building-blocks/components/icons/linkedin-icon/component",["exports","building-blocks/components/icons/linkedin-icon/template","building-blocks/mixins/svg-base"],function(e,t,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(n.default,{layout:t.default})}),define("building-blocks/components/icons/linkedin-icon/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"JM89h1c3",block:'{"symbols":[],"statements":[[6,"svg"],[9,"viewBox","0 0 24 24"],[7],[0,"\\n  "],[6,"path"],[10,"class",[25,"concat",["svg-",[20,["status"]]],null],null],[9,"d","M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 16h-2v-6h2v6zm-1-6.891c-.607 0-1.1-.496-1.1-1.109 0-.612.492-1.109 1.1-1.109s1.1.497 1.1 1.109c0 .613-.493 1.109-1.1 1.109zm8 6.891h-1.998v-2.861c0-1.881-2.002-1.722-2.002 0v2.861h-2v-6h2v1.093c.872-1.616 4-1.736 4 1.548v3.359z"],[7],[8],[0,"\\n"],[8],[0,"\\n"],[6,"circle"],[9,"class","svg-hover-background"],[10,"cx",[18,"radius"],null],[10,"cy",[18,"radius"],null],[10,"r",[18,"radius"],null],[7],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/icons/linkedin-icon/template.hbs"}})}),define("building-blocks/components/icons/loading-icon/component",["exports","building-blocks/components/icons/loading-icon/template","building-blocks/mixins/svg-base","d3-shape","ember-concurrency"],function(e,t,n,r,i){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=Ember.Component.extend(n.default,{layout:t.default,draw:function(){this.get("_spin").perform()},iconPathD:null,_spin:(0,i.task)(regeneratorRuntime.mark(function e(){var t,n,o,a
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:t=this.get("radius"),n=0,o=(o=.2*t)>10?10:o,a=(0,r.arc)().innerRadius(t-o).outerRadius(t)
case 5:return a.startAngle(n).endAngle(n+1.3),this.set("iconPathD",a()),e.next=10,(0,i.timeout)(50)
case 10:n+=.05,e.next=5
break
case 13:case"end":return e.stop()}},e,this)})).cancelOn("deactivate")})}),define("building-blocks/components/icons/loading-icon/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"RMcf9+sI",block:'{"symbols":[],"statements":[[6,"g"],[10,"transform",[26,["translate(",[18,"radius"],", ",[18,"radius"],")"]]],[7],[0,"\\n  "],[6,"path"],[10,"d",[18,"iconPathD"],null],[10,"class",[25,"concat",["svg-",[20,["status"]]],null],null],[7],[8],[0,"\\n"],[8],[0,"\\n"],[6,"circle"],[9,"class","svg-hover-background"],[10,"cx",[18,"radius"],null],[10,"cy",[18,"radius"],null],[10,"r",[18,"radius"],null],[7],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/icons/loading-icon/template.hbs"}})}),define("building-blocks/components/icons/twitter-icon/component",["exports","building-blocks/components/icons/twitter-icon/template","building-blocks/mixins/svg-base"],function(e,t,n){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(n.default,{layout:t.default})}),define("building-blocks/components/icons/twitter-icon/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"9cKT18UB",block:'{"symbols":[],"statements":[[6,"svg"],[9,"viewBox","0 0 24 24"],[7],[0,"\\n  "],[6,"path"],[10,"class",[25,"concat",["svg-",[20,["status"]]],null],null],[9,"d","M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm6.066 9.645c.183 4.04-2.83 8.544-8.164 8.544-1.622 0-3.131-.476-4.402-1.291 1.524.18 3.045-.244 4.252-1.189-1.256-.023-2.317-.854-2.684-1.995.451.086.895.061 1.298-.049-1.381-.278-2.335-1.522-2.304-2.853.388.215.83.344 1.301.359-1.279-.855-1.641-2.544-.889-3.835 1.416 1.738 3.533 2.881 5.92 3.001-.419-1.796.944-3.527 2.799-3.527.825 0 1.572.349 2.096.907.654-.128 1.27-.368 1.824-.697-.215.671-.67 1.233-1.263 1.589.581-.07 1.135-.224 1.649-.453-.384.578-.87 1.084-1.433 1.489z"],[7],[8],[0,"\\n"],[8],[0,"\\n"],[6,"circle"],[9,"class","svg-hover-background"],[10,"cx",[18,"radius"],null],[10,"cy",[18,"radius"],null],[10,"r",[18,"radius"],null],[7],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/icons/twitter-icon/template.hbs"}})}),define("building-blocks/components/layout/bottom-footer/component",["exports","building-blocks/components/layout/bottom-footer/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default})}),define("building-blocks/components/layout/bottom-footer/footer-icon/component",["exports","building-blocks/components/layout/bottom-footer/footer-icon/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:""})}),define("building-blocks/components/layout/bottom-footer/footer-icon/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"zwjH0hfj",block:'{"symbols":[],"statements":[[1,[25,"icon-component",null,[["icon","size","tooltip","status"],[[20,["icon"]],2,[20,["tooltip"]],"info"]]],false],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/layout/bottom-footer/footer-icon/template.hbs"}})}),define("building-blocks/components/layout/bottom-footer/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"fkYaaB/T",block:'{"symbols":["&default"],"statements":[[6,"div"],[9,"class","navbar navbar-inverse navbar-fixed-bottom"],[9,"role","navigation"],[7],[6,"div"],[9,"class","container"],[7],[0,"\\n  "],[6,"div"],[9,"class","navbar-text pull-left"],[7],[0,"\\n      "],[6,"p"],[7],[0,"© "],[1,[18,"copyRight"],false],[8],[0,"\\n  "],[8],[0,"\\n  "],[6,"div"],[9,"class","navbar-text pull-right"],[7],[0,"\\n    "],[11,1,[[25,"hash",null,[["footer-icon"],[[25,"component",["layout/bottom-footer/footer-icon"],null]]]]]],[0,"\\n  "],[8],[0,"\\n"],[8],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/layout/bottom-footer/template.hbs"}})}),define("building-blocks/components/layout/main-section/component",["exports","building-blocks/components/layout/main-section/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:""})})
define("building-blocks/components/layout/main-section/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"EsErKORC",block:'{"symbols":["&default"],"statements":[[6,"div"],[9,"class","container"],[9,"style","height:100vh;"],[7],[0,"\\n  "],[11,1],[0,"\\n"],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/layout/main-section/template.hbs"}})}),define("building-blocks/components/layout/nav-bar/component",["exports","building-blocks/components/layout/nav-bar/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:""})}),define("building-blocks/components/layout/nav-bar/nav-item/component",["exports","building-blocks/components/layout/nav-bar/nav-item/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:""})}),define("building-blocks/components/layout/nav-bar/nav-item/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"Og1clF6v",block:'{"symbols":[],"statements":[[6,"li"],[9,"class","active"],[7],[0,"\\n  "],[6,"a"],[10,"href",[18,"linkTo"],null],[7],[1,[18,"label"],false],[8],[0,"\\n"],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/layout/nav-bar/nav-item/template.hbs"}})}),define("building-blocks/components/layout/nav-bar/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"MD02Urx3",block:'{"symbols":["&default"],"statements":[[6,"div"],[9,"class","navbar navbar-default navbar-fixed-top"],[9,"role","navigation"],[7],[6,"div"],[9,"class","container"],[7],[0,"\\n  "],[6,"div"],[9,"class","navbar-header"],[7],[0,"\\n"],[0,"    "],[6,"button"],[9,"type","button"],[9,"class","navbar-toggle"],[9,"data-toggle","collapse"],[9,"data-target",".navbar-collapse"],[7],[0,"\\n        "],[6,"span"],[9,"class","sr-only"],[7],[0,"Toggle navigation"],[8],[0,"\\n        "],[6,"span"],[9,"class","icon-bar"],[7],[8],[0,"\\n        "],[6,"span"],[9,"class","icon-bar"],[7],[8],[0,"\\n        "],[6,"span"],[9,"class","icon-bar"],[7],[8],[0,"\\n    "],[8],[0,"\\n"],[0,"    "],[6,"a"],[9,"class","navbar-brand nav-bar-home"],[7],[0,"\\n      "],[11,1,[[25,"hash",null,[["home"],[true]]]]],[0,"\\n    "],[8],[0,"\\n  "],[8],[0,"\\n  "],[6,"div"],[9,"class","navbar-collapse collapse"],[7],[0,"\\n    "],[6,"ul"],[9,"class","nav navbar-nav navbar-right"],[7],[0,"\\n      "],[11,1,[[25,"hash",null,[["nav-item"],[[25,"component",["layout/nav-bar/nav-item"],null]]]]]],[0,"\\n    "],[8],[0,"\\n  "],[8],[0,"\\n"],[8],[8],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"building-blocks/components/layout/nav-bar/template.hbs"}})}),define("building-blocks/components/layout/side-bar/component",["exports","building-blocks/components/layout/side-bar/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default})}),define("building-blocks/components/layout/side-bar/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"WXb0W3ge",block:'{"symbols":["&default"],"statements":[[11,1]],"hasEval":false}',meta:{moduleName:"building-blocks/components/layout/side-bar/template.hbs"}})}),define("building-blocks/components/svg-tooltip-wrapper/component",["exports","building-blocks/components/svg-tooltip-wrapper/template"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
e.default=Ember.Component.extend({layout:t.default,tagName:"g",mouseOnTarget:!1,mouseOnTip:!1,didInsertElement:function(){this._super.apply(this,arguments),this.addMouseEventHandlers()},willDestroyElement:function(){this._super.apply(this,arguments),this.removeMouseEventHandlers()},addMouseEventHandlers:function(){var e=this
this.$().on("mouseenter",function(t){var n=void 0,r=t.clientX
n=r>window.innerWidth/2?"right: "+(r=window.innerWidth-r)+"px; ":"left: "+r+"px; "
var i=t.clientY
n=i>window.innerHeight/2?n+"bottom: "+(i=window.innerHeight-i)+"px;":n+"top: "+i+"px;",e.set("tooltipStyle",new Ember.String.htmlSafe(n)),e.set("mouseOnTarget",!0)}),this.$().on("mouseleave",function(){Ember.run.later(function(){e.set("mouseOnTarget",!1)},50)}),this.$("g.svg-tooltip-tip").on("mouseenter",function(){e.set("mouseOnTip",!0)}),this.$("g.svg-tooltip-tip").on("mouseleave",function(){Ember.run.later(function(){e.set("mouseOnTip",!1)},50)})},removeMouseEventHandlers:function(){this.$().off("mouseenter"),this.$().off("mouseleave"),this.$("g.svg-tooltip-tip").off("mouseenter"),this.$("g.svg-tooltip-tip").off("mouseleave")},showTooltip:Ember.computed("mouseOnTarget",function(){return this.get("mouseOnTarget")||this.get("mouseOnTip")})})}),define("building-blocks/components/svg-tooltip-wrapper/template",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"c+29hjp+",block:'{"symbols":["&default"],"statements":[[11,1,[[25,"hash",null,[["target"],[true]]]]],[0,"\\n"],[4,"if",[[20,["showTooltip"]]],null,{"statements":[[0,"  "],[6,"foreignObject"],[7],[0,"\\n    "],[6,"div"],[9,"class","svg-tooltip-tip"],[10,"style",[18,"tooltipStyle"],null],[7],[0,"\\n      "],[11,1,[[25,"hash",null,[["tip"],[true]]]]],[0,"\\n    "],[8],[0,"\\n  "],[8],[0,"\\n"]],"parameters":[]},null]],"hasEval":false}',meta:{moduleName:"building-blocks/components/svg-tooltip-wrapper/template.hbs"}})}),define("building-blocks/mixins/d3-chart-base",["exports"],function(e){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Mixin.create({tagName:"svg",attributeBindings:["width","height","dataTestId:data-test-id"],dataTestId:"icon",width:16,height:16,didReceiveAttrs:function(){this._super(),this.draw&&Ember.run.scheduleOnce("render",this,this.draw)}})}),define("ember-ajax/-private/promise",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
...
function x(e){return!!(0,a.default)(e)&&!!e.match(w)}function E(e){return"/"===e.charAt(0)}function O(e){return e.substring(1)}function T(e){var t
return E(e)&&(e=O(e)),"/"===(t=e).charAt(t.length-1)&&(e=e.slice(0,-1)),e}var C=0
b&&p.registerWaiter(function(){return 0===C}),e.default=h.create({contentType:"application/x-www-form-urlencoded; charset=UTF-8",headers:{},request:function(e,t){var n=this.options(e,t),r=this._makeRequest(n),i=new s.default(function(e,t){r.then(function(t){var n=t.response
...
u=a instanceof Error?a:"timeout"===i?new t.TimeoutError:"abort"===i?new t.AbortError:o.handleResponse(e.status,(0,r.default)(e.getAllResponseHeaders()),s,c),y.join(null,n,{payload:s,textStatus:i,jqXHR:e,errorThrown:a,response:u})}).always(function(){C-=1})},"ember-ajax: "+e.type+" "+e.url)
...
return i&&(i=T(i),n.push(i)),new RegExp("^(/)?"+i).test(e)?e:(E(e)&&(e=O(e)),n.push(e),n.join("/"))},handleResponse:function(e,n,r,i){var o=void 0
...
Object.defineProperty(e,"__esModule",{value:!0})
var n=Ember.$
e.default=t.default?najax:n.ajax}),define("ember-concurrency/-buffer-policy",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0})
...
this._generatorValue=n.value,n.done?this._generatorState="DONE":this._generatorState="HAS_MORE_VALUES"}catch(e){this._generatorValue=e,this._generatorState="ERRORED"}finally{this._expectsLinkedYield&&(this._generatorValue&&this._generatorValue._performType===o||Ember.Logger.warn("You performed a .linked() task without immediately yielding/returning it. This is currently unsupported (but might be supported in future version of ember-concurrency)."),this._expectsLinkedYield=!1),a.pop()}},_getIterator:function(){return this.iterator||(this.iterator=this._makeIterator()),this.iterator},_makeIterator:function(){return this.fn.apply(this.context,this.args)},_advanceIndex:function(e){if(this._index===e)return++this._index},_proceedSoon:function(e,t){var n=this
...
var u,c,l,f="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},h=Ember.Object.extend({_task:null,_performType:null,_linkedObject:null,perform:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return new(Function.prototype.bind.apply(i.TaskGroupProperty,[null].concat(t)))},e.events=function(e,t){return o.default.create({obj:e,eventName:t})},e.all=a.all,e.allSettled=a.allSettled,e.didCancel=r.didCancel,e.hash=a.hash,e.race=a.race,e.timeout=t.timeout,e.waitForQueue=s.waitForQueue,e.waitForEvent=s.waitForEvent}),define("ember-concurrency/utils",["exports"],function(e){"use strict"
